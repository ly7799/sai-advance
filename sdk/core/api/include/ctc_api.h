...
struct ctc_api_s
{
    ...
    int32(*ctc_linkagg_add_ports)(uint8, uint32, ctc_linkagg_port_t*);
    ...
    int32(*ctc_linkagg_remove_ports)(uint8, uint32, ctc_linkagg_port_t*);
    ...
    int32(*ctc_nh_remove_aps)(uint32);
...
extern int32 ctc_diag_get_lb_distribution(uint8 lchip,ctc_diag_lb_dist_t* p_para);
extern int32 ctc_diag_get_memory_usage(uint8 lchip,ctc_diag_mem_usage_t* p_para);
...
extern int32 ctc_diag_mem_bist(uint8 lchip, ctc_diag_bist_mem_type_t mem_type, uint8* p_err_mem_id);
extern int32 ctc_diag_set_lb_distribution(uint8 lchip,ctc_diag_lb_dist_t* p_para);
extern int32 ctc_diag_set_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctc_diag_tbl_control(uint8 lchip, ctc_diag_tbl_t* p_para);
...
extern int32 ctc_linkagg_add_ports(uint8 tid, uint32 member_cnt, ctc_linkagg_port_t* p_ports);
...
extern int32 ctc_linkagg_remove_ports(uint8 tid, uint32 member_cnt, ctc_linkagg_port_t* p_ports);
...
extern int32 ctc_nh_add_aps(uint32 nhid, ctc_nh_aps_param_t* p_nh_param);
...
extern int32 ctc_nh_remove_aps(uint32 nhid);
...
extern int32 ctc_nh_update_aps(uint32 nhid, ctc_nh_aps_param_t* p_nh_param);
