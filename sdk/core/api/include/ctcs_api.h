...
struct ctcs_api_s
{
    ...
    int32(*ctcs_diag_get_lb_distribution)(uint8, ctc_diag_lb_dist_t*);
    int32(*ctcs_diag_get_memory_usage)(uint8, ctc_diag_mem_usage_t*);
    ...
    int32(*ctcs_diag_mem_bist)(uint8, ctc_diag_bist_mem_type_t, uint8*);
    int32(*ctcs_diag_set_lb_distribution)(uint8, ctc_diag_lb_dist_t*);
    int32(*ctcs_diag_set_property)(uint8, ctc_diag_property_t, void*);
    int32(*ctcs_diag_tbl_control)(uint8, ctc_diag_tbl_t*);
    ...
    int32(*ctcs_linkagg_add_ports)(uint8, uint8, uint32, ctc_linkagg_port_t*);
    ...
    int32(*ctcs_linkagg_remove_ports)(uint8, uint8, uint32, ctc_linkagg_port_t*);
    ...
    int32(*ctcs_monitor_get_global_config)(uint8, ctc_monitor_glb_cfg_t*);
    ...
    int32(*ctcs_mpls_get_ilm_property)(uint8, ctc_mpls_property_t*);
    ...
    int32(*ctcs_nh_add_aps)(uint8, uint32, ctc_nh_aps_param_t*);
    ...
    int32(*ctcs_nh_get_mpls_tunnel_label)(uint8, uint16, ctc_mpls_nexthop_tunnel_param_t*);
    ...
    int32(*ctcs_nh_remove_aps)(uint8, uint32);
    ...
    int32(*ctcs_nh_update_aps)(uint8, uint32, ctc_nh_aps_param_t*);
    ...
    int32(*ctcs_packet_rx_register)(uint8, ctc_pkt_rx_register_t*);
    int32(*ctcs_packet_rx_unregister)(uint8, ctc_pkt_rx_register_t*);
    ...
    int32(*ctcs_port_set_capability)(uint8, uint32, ctc_port_capability_type_t, uint32);
    ...
    int32(*ctcs_scl_add_action_field_list)(uint8, uint32, ctc_scl_field_action_t*, uint32*);
    int32(*ctcs_scl_add_entry)(uint8, uint32, ctc_scl_entry_t*);
    int32(*ctcs_scl_add_key_field)(uint8, uint32, ctc_field_key_t*);
    int32(*ctcs_scl_add_key_field_list)(uint8, uint32, ctc_field_key_t*, uint32*);
...
extern int32 ctcs_diag_get_lb_distribution(uint8 lchip,ctc_diag_lb_dist_t* p_para);
extern int32 ctcs_diag_get_memory_usage(uint8 lchip,ctc_diag_mem_usage_t* p_para);
...
extern int32 ctcs_diag_mem_bist(uint8 lchip, ctc_diag_bist_mem_type_t mem_type, uint8* p_err_mem_id);
extern int32 ctcs_diag_set_lb_distribution(uint8 lchip,ctc_diag_lb_dist_t* p_para);
extern int32 ctcs_diag_set_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctcs_diag_tbl_control(uint8 lchip, ctc_diag_tbl_t* p_para);
...
extern int32 ctcs_linkagg_add_ports(uint8 lchip, uint8 tid, uint32 member_cnt, ctc_linkagg_port_t* p_ports);
...
extern int32 ctcs_linkagg_remove_ports(uint8 lchip, uint8 tid, uint32 member_cnt, ctc_linkagg_port_t* p_ports);
...
extern int32 ctcs_monitor_get_global_config(uint8 lchip, ctc_monitor_glb_cfg_t* p_cfg);
...
extern int32 ctcs_mpls_get_ilm_property(uint8 lchip, ctc_mpls_property_t* p_mpls_pro);
...
extern int32 ctcs_nh_add_aps(uint8 lchip, uint32 nhid, ctc_nh_aps_param_t* p_nh_param);
...
extern int32 ctcs_nh_get_mpls_tunnel_label(uint8 lchip, uint16 tunnel_id, ctc_mpls_nexthop_tunnel_param_t* p_param);
...
extern int32 ctcs_nh_remove_aps(uint8 lchip, uint32 nhid);
...
extern int32 ctcs_nh_update_aps(uint8 lchip, uint32 nhid, ctc_nh_aps_param_t* p_nh_param);
...
extern int32 ctcs_packet_rx_register(uint8 lchip, ctc_pkt_rx_register_t* p_register);
extern int32 ctcs_packet_rx_unregister(uint8 lchip, ctc_pkt_rx_register_t* p_register);
...
extern int32 ctcs_port_set_capability(uint8 lchip, uint32 gport, ctc_port_capability_type_t type, uint32 value);
...
extern int32 ctcs_scl_add_action_field_list(uint8 lchip, uint32 entry_id, ctc_scl_field_action_t* p_field_list, uint32* p_field_cnt);
...
extern int32 ctcs_scl_add_key_field_list(uint8 lchip, uint32 entry_id, ctc_field_key_t* p_field_list, uint32* p_field_cnt);
