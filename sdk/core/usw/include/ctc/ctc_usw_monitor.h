...
/**
 @brief Get monitor global configure

 @param[in] lchip    local chip id

 @param[in|out] p_cfg  monitor global configure

 @remark[D2.TM]

 Get buffer and latency global configure include latency level threshold and buffer log mode.
 refer to ctc_monitor_glb_config_type_t;
...
*/
 extern int32
ctc_usw_monitor_get_global_config(uint8 lchip, ctc_monitor_glb_cfg_t* p_cfg);
