...
STATIC int32
_sys_goldengate_cfm_maid_check_param(uint8 lchip, void* p_maid_param, bool is_add)
{
...
STATIC int32
_sys_goldengate_cfm_chan_check_param(uint8 lchip, ctc_oam_lmep_t* p_chan_param, bool is_add)
{
    uint16 gport       = 0;
    uint8  is_up       = 0;
    uint8  is_link_oam = 0;
    ...
    if (is_l2vpn_oam)
    {
        ...
        if (!l2vpn_oam_mode)
        {
            ...
            {
                if (p_chan_param->key.u.eth.l2vpn_oam_id > 0x1FFF)
                {
            ...
            {
                if (TABLE_MAX_INDEX(DsMac_t) < 0x3000)/*12K*/
                {
                    return CTC_E_NOT_SUPPORT;
                }
                if (p_chan_param->key.u.eth.l2vpn_oam_id > 0xFFF)
                {
                    return CTC_E_INVALID_PARAM;
                }
            }
...
STATIC int32
_sys_goldengate_cfm_lmep_check_param(uint8 lchip, ctc_oam_lmep_t* p_lmep_param, bool is_add)
{
    ...
    CTC_GLOBAL_PORT_CHECK(p_lmep_param->key.u.eth.gport)
    /* check md level */
    ...
    if (is_add)
    {
        ...
        if (CTC_OAM_MEP_TYPE_ETH_Y1731 == p_lmep_param->key.mep_type)
        {
            if (CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_TX_PORT_STATUS)
                || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_TX_IF_STATUS)
            || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_TX_SEND_ID)
            || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_CCM_SEQ_NUM_EN))
            {
                return CTC_E_OAM_INVALID_CFG_IN_MEP_TYPE;
            }
        }
        else if (CTC_OAM_MEP_TYPE_ETH_1AG == p_lmep_param->key.mep_type)
        {
            if (CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_DM_EN)
                || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_LM_EN)
            || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_TX_CSF_EN)
            || CTC_FLAG_ISSET(p_lmep_param->u.y1731_lmep.flag, CTC_OAM_Y1731_LMEP_FLAG_WITHOUT_GAL))
            {
                return CTC_E_OAM_INVALID_CFG_IN_MEP_TYPE;
            }
        }
...
STATIC int32
_sys_goldengate_cfm_rmep_check_param(uint8 lchip, ctc_oam_rmep_t* p_rmep_param, bool is_add)
{
    ...
    CTC_GLOBAL_PORT_CHECK(p_rmep_param->key.u.eth.gport);
    ...
    if (is_add)
    {
        ...
        if (CTC_OAM_MEP_TYPE_ETH_Y1731 == p_rmep_param->key.mep_type)
        {
            if (CTC_FLAG_ISSET(p_rmep_param->u.y1731_rmep.flag, CTC_OAM_Y1731_RMEP_FLAG_CCM_SEQ_NUM_EN))
            {
                return CTC_E_OAM_INVALID_CFG_IN_MEP_TYPE;
            }
        }
        else if (CTC_OAM_MEP_TYPE_ETH_1AG == p_rmep_param->key.mep_type)
        {
            if (CTC_FLAG_ISSET(p_rmep_param->u.y1731_rmep.flag, CTC_OAM_Y1731_RMEP_FLAG_CSF_EN))
            {
                return CTC_E_OAM_INVALID_CFG_IN_MEP_TYPE;
            }
        }
...
STATIC int32
_sys_goldengate_cfm_check_update_param(uint8 lchip, ctc_oam_update_t* p_update_param, bool is_local)
{
    ...
    CTC_GLOBAL_PORT_CHECK(p_eth_update->key.u.eth.gport);
...
STATIC int32
_sys_goldengate_cfm_mip_check_param(uint8 lchip, ctc_oam_mip_t* p_mip_param, bool is_add)
{
    SYS_OAM_DBG_FUNC();

    CTC_PTR_VALID_CHECK(p_mip_param);

    CTC_GLOBAL_PORT_CHECK(p_mip_param->key.u.eth.gport);
...
STATIC int32
_sys_goldengate_cfm_add_chan(uint8 lchip, void* p_chan, void** p_sys_chan)
{
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_chan_check_param(lchip, p_chan_param, TRUE));

    /*2. lookup chan and check exist*/
    p_sys_chan_eth = _sys_goldengate_cfm_chan_lkup(lchip, &p_chan_param->key);
    ...
    p_sys_chan_eth = _sys_goldengate_cfm_chan_build_node(lchip, p_chan_param);
    if (NULL == p_sys_chan_eth)
    {
    ...
    /*4. build chan index*/
    ret = _sys_goldengate_cfm_chan_build_index(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*5. add chan to db*/
    ret = _sys_goldengate_cfm_chan_add_to_db(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    ret = _sys_goldengate_cfm_chan_add_to_asic(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
...
STEP_5:
    _sys_goldengate_cfm_chan_del_from_db(lchip, p_sys_chan_eth);
STEP_4:
    _sys_goldengate_cfm_chan_free_index(lchip, p_sys_chan_eth);
STEP_3:
    _sys_goldengate_cfm_chan_free_node(lchip, p_sys_chan_eth);
...
STATIC int32
_sys_goldengate_cfm_remove_chan(uint8 lchip, void* p_chan)
{
    ctc_oam_lmep_t* p_chan_param = (ctc_oam_lmep_t*)p_chan;
    sys_oam_chan_eth_t* p_sys_chan_eth = NULL;
    int32 ret = CTC_E_NONE;
    ...
    /*1. check param valid*/
    CTC_ERROR_RETURN(_sys_goldengate_cfm_chan_check_param(lchip, p_chan_param, FALSE));
    ...
    ret = _sys_goldengate_cfm_chan_del_from_asic(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    ret = _sys_goldengate_cfm_chan_del_from_db(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*6. free chan node*/
    ret = _sys_goldengate_cfm_chan_free_node(lchip, p_sys_chan_eth);
    if (CTC_E_NONE != ret)
    {
...
STATIC int32
_sys_goldengate_cfm_add_lmep(uint8 lchip, void* p_lmep)
{
    ...
    ret = _sys_goldengate_cfm_lmep_check_param(lchip, p_lmep_param, TRUE);
    if (CTC_E_NONE != ret)
    {
        goto RETURN;
    }
    ...
    ret = _sys_goldengate_cfm_add_chan(lchip, p_lmep_param, (void**)&p_sys_chan_eth);
    ...
    p_sys_maid_eth = _sys_goldengate_oam_maid_lkup(lchip, &p_lmep_param->maid);
    if ((NULL == p_sys_maid_eth)&&(!g_gg_oam_master[lchip]->no_mep_resource))
    {
...
#if 0
    /* check master chip or not*/
    if (CTC_E_NONE != sys_goldengate_oam_check_mep_lchip(lchip, p_lmep_param->u.y1731_lmep.master_gchip, &lchip))
    {
        /*only update chan*/
        ret = _sys_goldengate_cfm_chan_update_reomte(lchip, p_lmep_param, p_sys_chan_eth, TRUE);
        goto RETURN;
    }
#endif
    ...
    p_sys_lmep_eth = _sys_goldengate_cfm_lmep_build_node(lchip, p_lmep_param);
    if (NULL == p_sys_lmep_eth)
    {
    ...
    /*6. build lmep index */
    ret = _sys_goldengate_cfm_lmep_build_index(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*7. add lmep to db */
    ret = _sys_goldengate_cfm_lmep_add_to_db(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*8. write lmep asic*/
    ret = _sys_goldengate_cfm_lmep_add_to_asic(lchip, p_lmep_param, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*9. build lm index*/
    ret = _sys_goldengate_cfm_lmep_build_lm_index(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
        SYS_OAM_DBG_ERROR("Lmep: build lm index fail!!\n");
        goto STEP_8;
    }

    /*10. update chan*/
    ret = _sys_goldengate_cfm_chan_update(lchip, p_sys_lmep_eth, TRUE);
    if (CTC_E_NONE != ret)
    {
    ...
    sys_goldengate_oam_get_session_type(lchip, (sys_oam_lmep_com_t*)p_sys_lmep_eth, &session_type);
...
STEP_9:
    _sys_goldengate_cfm_lmep_free_lm_index(lchip, p_sys_lmep_eth);
STEP_8:
    _sys_goldengate_cfm_lmep_del_from_asic(lchip, p_sys_lmep_eth);
STEP_7:
    _sys_goldengate_cfm_lmep_del_from_db(lchip, p_sys_lmep_eth);
STEP_6:
    _sys_goldengate_cfm_lmep_free_index(lchip, p_sys_lmep_eth);
STEP_5:
    _sys_goldengate_cfm_lmep_free_node(lchip, p_sys_lmep_eth);
    if (p_sys_maid_eth)
    {
        p_sys_maid_eth->ref_cnt--;
    }
STEP_4:
     _sys_goldengate_cfm_remove_chan(lchip, p_lmep_param);
...
STATIC int32
_sys_goldengate_cfm_remove_lmep(uint8 lchip, void* p_lmep)
{
    ctc_oam_lmep_t* p_lmep_param = (ctc_oam_lmep_t*)p_lmep;
    sys_oam_chan_eth_t* p_sys_chan_eth = NULL;
    sys_oam_lmep_y1731_t* p_sys_lmep_eth = NULL;
    ...
    /*1. check param valid (lmep)*/
    CTC_ERROR_RETURN(_sys_goldengate_cfm_lmep_check_param(lchip, p_lmep_param, FALSE));
    ...
    {
        /*only update chan*/
        ret = _sys_goldengate_cfm_chan_update_reomte(lchip, p_lmep_param, p_sys_chan_eth, FALSE);
        goto STEP_3;
    }
#endif
    ...
    /*5. free lm index */
    ret = _sys_goldengate_cfm_lmep_free_lm_index(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
        SYS_OAM_DBG_ERROR("Lmep: free lm index fail!!\n");
        goto RETURN;
    }


    /*6. update chan*/
    ret = _sys_goldengate_cfm_chan_update(lchip, p_sys_lmep_eth, FALSE);
    if (CTC_E_NONE != ret)
    {
        SYS_OAM_DBG_ERROR("Lmep: update chan fail!!\n");
        goto RETURN;
    ...
    ret = _sys_goldengate_cfm_lmep_del_from_asic(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    ret = _sys_goldengate_cfm_lmep_del_from_db(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*9. free lmep index*/
    ret = _sys_goldengate_cfm_lmep_free_index(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*10. free lmep node*/
    ret = _sys_goldengate_cfm_lmep_free_node(lchip, p_sys_lmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    ret = _sys_goldengate_cfm_remove_chan(lchip, p_lmep_param);
...
STATIC int32
_sys_goldengate_cfm_update_lmep_assigned_level(uint8 lchip, void* p_lmep)
{
    ...
    ret = _sys_goldengate_cfm_lmep_update_asic(lchip, p_lmep_param, p_sys_lmep_eth);

    return ret;
}

STATIC int32
_sys_goldengate_cfm_update_lmep(uint8 lchip, void* p_lmep)
{
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_check_update_param(lchip, p_lmep_update, TRUE));
    ...
    if (p_lmep_update->is_local)
    {
        ...
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_TX_CSF_TYPE:
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_TX_CSF_USE_UC_DA:
            ret = _sys_goldengate_cfm_update_lmep_assigned_level(lchip, (void*)p_lmep_update);
            break;

        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_PORT_STATUS:
            ret = _sys_goldengate_cfm_update_lmep_port_status(lchip, p_lmep_update);
            break;

        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_IF_STATUS:
            ret = _sys_goldengate_cfm_update_lmep_if_status(lchip, p_lmep_update);
            break;
        ...
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_LM_COS_TYPE:
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_LM_COS:
            ret = _sys_goldengate_cfm_update_lmep_lm(lchip, p_lmep_update);
            break;
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_TRPT:
            ret = _sys_goldengate_cfm_update_lmep_trpt(lchip, p_lmep_update);
            break;
        case CTC_OAM_Y1731_LMEP_UPDATE_TYPE_MASTER_GCHIP:
            ret = _sys_goldengate_cfm_update_master_gchip(lchip, p_lmep_update);
            break;
...
STATIC int32
_sys_goldengate_cfm_add_rmep(uint8 lchip, void* p_rmep)
{
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_rmep_check_param(lchip, p_rmep_param, TRUE));

    OAM_LOCK(lchip);

    /*2. lookup chan and check exist*/
    p_sys_chan_eth = _sys_goldengate_cfm_chan_lkup(lchip, &p_rmep_param->key);
    if (NULL == p_sys_chan_eth)
    {
        ret = CTC_E_OAM_CHAN_ENTRY_NOT_FOUND;
        goto RETURN;
    ...
    p_sys_rmep_eth = _sys_goldengate_cfm_rmep_lkup(lchip, rmep_id, p_sys_lmep_eth);
    ...
    p_sys_rmep_eth = _sys_goldengate_cfm_rmep_build_node(lchip, p_rmep_param);
    if (NULL == p_sys_rmep_eth)
    {
    ...
    /*6. build rmep index */
    ret = _sys_goldengate_cfm_rmep_build_index(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*7. add rmep to db */
    ret = _sys_goldengate_cfm_rmep_add_to_db(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*8. write rmep asic*/
    ret = _sys_goldengate_cfm_rmep_add_to_asic(lchip, p_rmep_param, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
...
STEP_7:
    _sys_goldengate_cfm_rmep_del_from_db(lchip, p_sys_rmep_eth);
STEP_6:
    _sys_goldengate_cfm_rmep_free_index(lchip, p_sys_rmep_eth);
STEP_5:
    _sys_goldengate_cfm_rmep_free_node(lchip, p_sys_rmep_eth);
...
STATIC int32
_sys_goldengate_cfm_remove_rmep(uint8 lchip, void* p_rmep)
{
    ctc_oam_rmep_t* p_rmep_param = (ctc_oam_rmep_t*)p_rmep;
    sys_oam_chan_eth_t* p_sys_chan_eth = NULL;
    sys_oam_lmep_y1731_t* p_sys_lmep_eth = NULL;
    ...
    /*1. check param valid (rmep)*/
    CTC_ERROR_RETURN(_sys_goldengate_cfm_rmep_check_param(lchip, p_rmep_param, FALSE));
    ...
    ret = _sys_goldengate_cfm_rmep_del_from_asic(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    ret = _sys_goldengate_cfm_rmep_del_from_db(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*7. free rmep index*/
    ret = _sys_goldengate_cfm_rmep_free_index(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
    ...
    /*8. free rmep node*/
    ret = _sys_goldengate_cfm_rmep_free_node(lchip, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
...
STATIC int32
_sys_goldengate_cfm_update_rmep(uint8 lchip, void* p_rmep)
{
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_check_update_param(lchip, p_rmep_param, FALSE));
    ...
    ret = _sys_goldengate_cfm_rmep_update_asic(lchip, p_rmep_param, p_sys_rmep_eth);
    if (CTC_E_NONE != ret)
    {
...
STATIC int32
_sys_goldengate_cfm_add_mip(uint8 lchip, void* p_mip)
{
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_mip_check_param(lchip, p_mip_param, TRUE));

    OAM_LOCK(lchip);
    /*2. check & add chan*/
    p_sys_chan_eth = _sys_goldengate_cfm_chan_lkup(lchip, &p_mip_param->key);
    if (NULL == p_sys_chan_eth)
    {
        ret = _sys_goldengate_cfm_add_chan(lchip, &chan_param, (void**)&p_sys_chan_eth);
        if (CTC_E_NONE != ret)
        {
            goto RETURN;
        }
    ...
    /*3.update db&asic*/
    ret = _sys_goldengate_cfm_chan_update_mip(lchip, p_sys_chan_eth, md_level, TRUE);
    if (CTC_E_NONE != ret)
    {
        _sys_goldengate_cfm_chan_update_mip(lchip, p_sys_chan_eth, md_level, FALSE);
        _sys_goldengate_cfm_remove_chan(lchip, &chan_param);
    }
...
STATIC int32
_sys_goldengate_cfm_remove_mip(uint8 lchip, void* p_mip)
{
    ctc_oam_mip_t* p_mip_param = NULL;
    sys_oam_chan_eth_t* p_sys_chan_eth = NULL;
    ctc_oam_lmep_t      chan_param;
    ...
    md_level = p_mip_param->key.u.eth.md_level;
    /*1. check param valid (mip)*/
    CTC_ERROR_RETURN(_sys_goldengate_cfm_mip_check_param(lchip, p_mip_param, FALSE));
    ...
    /*4. remove chan*/
    ret = _sys_goldengate_cfm_remove_chan(lchip, &chan_param);
...
STATIC int32
_sys_goldengate_cfm_set_property(uint8 lchip, void* p_prop)
{
    ...
    case CTC_OAM_Y1731_CFG_TYPE_PORT_OAM_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_port_oam_en(lchip, p_eth_prop->gport, p_eth_prop->dir, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_PORT_TUNNEL_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_port_tunnel_en(lchip, p_eth_prop->gport, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_ALL_TO_CPU:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_relay_all_to_cpu_en(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_ADD_EDGE_PORT:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_port_edge_en(lchip, p_eth_prop->gport, 1));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_REMOVE_EDGE_PORT:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_port_edge_en(lchip, p_eth_prop->gport, 0));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_TX_VLAN_TPID:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_tx_vlan_tpid(lchip, (p_eth_prop->value >> 16) & 0xFFFF, p_eth_prop->value & 0xFFFF));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_RX_VLAN_TPID:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_rx_vlan_tpid(lchip, (p_eth_prop->value >> 16) & 0xFFFF, p_eth_prop->value & 0xFFFF));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_SENDER_ID:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_send_id(lchip, (ctc_oam_eth_senderid_t*)p_eth_prop->p_value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_BIG_CCM_INTERVAL_TO_CPU:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_big_ccm_interval(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_PORT_LM_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_port_lm_en(lchip, p_eth_prop->gport, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_BRIDGE_MAC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_bridge_mac(lchip, (mac_addr_t*)p_eth_prop->p_value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LBM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_lbm_process_by_asic(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LBR_SA_USE_LBM_DA:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_lbr_sa_use_lbm_da(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LBR_SA_SHARE_MAC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_lbr_sa_use_bridge_mac(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LMM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_lmm_process_by_asic(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_DM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_dm_process_by_asic(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_SLM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_slm_process_by_asic(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_L2VPN_OAM_MODE:
        CTC_ERROR_RETURN(
        _sys_goldengate_cfm_oam_set_l2vpn_oam_mode(lchip, p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_TP_ACH_CHAN_TYPE:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_set_ach_channel_type(lchip, (uint16)p_eth_prop->value));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_IF_STATUS:
        CTC_MAX_VALUE_CHECK(p_eth_prop->value, 7);
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_set_if_status(lchip, p_eth_prop->gport, p_eth_prop->value));
...
_sys_goldengate_cfm_get_property(uint8 lchip, void* p_prop)
{
    ...
    case CTC_OAM_Y1731_CFG_TYPE_PORT_OAM_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_port_oam_en(lchip, p_eth_prop->gport, p_eth_prop->dir, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_PORT_TUNNEL_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_port_tunnel_en(lchip, p_eth_prop->gport, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_BIG_CCM_INTERVAL_TO_CPU:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_big_ccm_interval(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_PORT_LM_EN:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_port_lm_en(lchip, p_eth_prop->gport, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LBM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_lbm_process_by_asic(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LMM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_lmm_process_by_asic(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_DM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_dm_process_by_asic(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_SLM_PROC_IN_ASIC:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_slm_process_by_asic(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_LBR_SA_USE_LBM_DA:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_lbr_sa_use_lbm_da(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_L2VPN_OAM_MODE:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_l2vpn_oam_mode(lchip, (uint8*)&value_tmp8));
        break;

    case CTC_OAM_Y1731_CFG_TYPE_TP_ACH_CHAN_TYPE:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_ach_channel_type(lchip, (uint16*)&value_tmp16));
    ...
    case CTC_OAM_Y1731_CFG_TYPE_IF_STATUS:
        CTC_ERROR_RETURN(
            _sys_goldengate_cfm_oam_get_if_status(lchip, p_eth_prop->gport, (uint8*)&value_tmp8));
         break;
...
STATIC int32
_sys_goldengate_cfm_get_stats_info(uint8 lchip, void* p_stat_info)
{
    ...
    /*1. lookup chan and check exist*/
    p_sys_chan_eth = _sys_goldengate_cfm_chan_lkup(lchip, &p_sys_stat->key);
    if (NULL == p_sys_chan_eth)
    {
        return CTC_E_OAM_CHAN_ENTRY_NOT_FOUND;
    }
...
STATIC int32
_sys_goldengate_cfm_get_mep_info(uint8 lchip, void* p_mep_info)
{
    ...
    /*2. lookup chan and check exist*/
    p_sys_chan = _sys_goldengate_cfm_chan_lkup(lchip, &p_mep_param->key);
    if (NULL == p_sys_chan)
    {
        ret = CTC_E_OAM_CHAN_ENTRY_NOT_FOUND;
        goto RETURN;
    ...
    /*3. lookup lmep and check exist*/
    p_sys_lmep = _sys_goldengate_cfm_lmep_lkup(lchip, p_mep_param->key.u.eth.md_level, p_sys_chan);
    if (NULL == p_sys_lmep)
    {
        ret = CTC_E_OAM_CHAN_LMEP_NOT_FOUND;
        goto RETURN;
    ...
    /*4. lookup rmep and check exist*/
    p_sys_rmep = _sys_goldengate_cfm_rmep_lkup(lchip, p_mep_param->rmep_id, p_sys_lmep);
    if (NULL == p_sys_rmep)
    {
        ret = CTC_E_OAM_RMEP_NOT_FOUND;
        goto RETURN;
...
sys_goldengate_cfm_init(uint8 lchip, ctc_oam_global_t* p_eth_glb)
{
    ...
    *************************************************/
    ...
    CTC_ERROR_RETURN(_sys_goldengate_cfm_register_init(lchip));
    /*************************************************
    *init callback fun
    *************************************************/

    /*check*/
    SYS_OAM_CHECK_FUNC_TABLE(lchip, oam_type, SYS_OAM_CHECK_MAID)     = _sys_goldengate_cfm_maid_check_param;
    ...
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_CHAN, SYS_OAM_CMP)    = _sys_goldengate_cfm_chan_lkup_cmp;

    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_LMEP, SYS_OAM_ADD)    = _sys_goldengate_cfm_add_lmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_LMEP, SYS_OAM_DEL)    = _sys_goldengate_cfm_remove_lmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_LMEP, SYS_OAM_UPDATE) = _sys_goldengate_cfm_update_lmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_LMEP, SYS_OAM_CMP)    = _sys_goldengate_cfm_lmep_lkup_cmp;

    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_RMEP, SYS_OAM_ADD)    = _sys_goldengate_cfm_add_rmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_RMEP, SYS_OAM_DEL)    = _sys_goldengate_cfm_remove_rmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_RMEP, SYS_OAM_UPDATE) = _sys_goldengate_cfm_update_rmep;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_RMEP, SYS_OAM_CMP)    = _sys_goldengate_cfm_rmep_lkup_cmp;

    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_MIP, SYS_OAM_ADD)    = _sys_goldengate_cfm_add_mip;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_MIP, SYS_OAM_DEL)    = _sys_goldengate_cfm_remove_mip;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_GLOB, SYS_OAM_GET_INFO)    = _sys_goldengate_cfm_get_mep_info;
    ...
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_STATS, SYS_OAM_CONFIG)    = _sys_goldengate_cfm_get_stats_info;
    SYS_OAM_FUNC_TABLE(lchip, oam_type, SYS_OAM_GLOB, SYS_OAM_GET_INFO)    = _sys_goldengate_cfm_get_mep_info;

    SYS_OAM_FUNC_TABLE(lchip, CTC_OAM_PROPERTY_TYPE_Y1731, SYS_OAM_GLOB, SYS_OAM_CONFIG) = _sys_goldengate_cfm_set_property;
