...
*/
int32
sys_goldengate_parser_io_set_parser_pbb_ctl(uint8 lchip, ParserPbbCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_pbb_ctl(uint8 lchip, ParserPbbCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_packet_type(uint8 lchip, ParserPacketTypeMap_m* p_map)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_ethernet_ctl(uint8 lchip, ParserEthernetCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_ethernet_ctl(uint8 lchip, ParserEthernetCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_cvlan_tpid(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_cvlan_tpid(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_max_length(uint8 lchip, uint32 len)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_max_length(uint8 lchip, uint32* p_len)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_i_tag_tpid(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_i_tag_tpid(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_cn_tag_tpid(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_cn_tag_tpid(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_evb_tpid(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_evb_tpid(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_bvlan_tpid(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_bvlan_tpid(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_vlan_parsing_num(uint8 lchip, uint32 num)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_vlan_parsing_num(uint8 lchip, uint32* p_num)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_svlan_tpid0(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
    ...
    CTC_ERROR_RETURN(sys_goldengate_packet_tx_set_property(lchip, SYS_PKT_TX_TYPE_TPID, 0, tpid));
...
*/
int32
sys_goldengate_parser_io_get_svlan_tpid0(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_svlan_tpid1(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
    ...
    CTC_ERROR_RETURN(sys_goldengate_packet_tx_set_property(lchip, SYS_PKT_TX_TYPE_TPID, 1, tpid));
...
*/
int32
sys_goldengate_parser_io_get_svlan_tpid1(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_svlan_tpid2(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
    ...
    CTC_ERROR_RETURN(sys_goldengate_packet_tx_set_property(lchip, SYS_PKT_TX_TYPE_TPID, 2, tpid));
...
*/
int32
sys_goldengate_parser_io_get_svlan_tpid2(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_svlan_tpid3(uint8 lchip, uint32 tpid)
{
    uint32 cmd = 0;
    ...
    CTC_ERROR_RETURN(sys_goldengate_packet_tx_set_property(lchip, SYS_PKT_TX_TYPE_TPID, 3, tpid));
...
*/
int32
sys_goldengate_parser_io_get_svlan_tpid3(uint8 lchip, uint32* p_tpid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer2_protocol_cam_valid(uint8 lchip, ParserLayer2ProtocolCamValid_m* p_valid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer2_protocol_cam_valid(uint8 lchip,
...
*/
int32
sys_goldengate_parser_io_set_parser_layer2_protocol_cam(uint8 lchip, ParserLayer2ProtocolCam_m* p_cam)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer2_protocol_cam(uint8 lchip, ParserLayer2ProtocolCam_m* p_cam)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_ip_ctl(uint8 lchip, ParserIpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_ip_ctl(uint8 lchip, ParserIpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_mpls_ctl(uint8 lchip, ParserMplsCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_mpls_ctl(uint8 lchip, ParserMplsCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_trill_ctl(uint8 lchip, ParserTrillCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_trill_ctl(uint8 lchip, ParserTrillCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_l3_hash_ctl_entry(uint8 lchip, ParserLayer3HashCtl_m* p_parser_l3_hash_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_l3_hash_ctl_entry(uint8 lchip, ParserLayer3HashCtl_m* p_parser_l3_hash_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer3_type_ctl(uint8 lchip, ParserL3Ctl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer3_type_ctl(uint8 lchip, ParserL3Ctl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer3_protocol_cam_valid(uint8 lchip,
...
*/
int32
sys_goldengate_parser_io_get_parser_layer3_protocol_cam_valid(uint8 lchip,
                                                              ParserLayer3ProtocolCamValid_m* p_valid)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer3_protocol_cam(uint8 lchip,
...
*/
int32
sys_goldengate_parser_io_get_parser_layer3_protocol_cam(uint8 lchip,
                                                        ParserLayer3ProtocolCam_m* p_cam)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer3_protocol_ctl(uint8 lchip,
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_flag_op_ctl(uint8 lchip, ParserLayer4FlagOpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_flag_op_ctl(uint8 lchip, ParserLayer4FlagOpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_port_op_sel(uint8 lchip, ParserLayer4PortOpSel_m* p_sel)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_sel);
    cmd = DRV_IOW(ParserLayer4PortOpSel_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_sel));
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_port_op_sel(uint8 lchip, ParserLayer4PortOpSel_m* p_sel)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_port_op_ctl(uint8 lchip, ParserLayer4PortOpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_port_op_ctl(uint8 lchip, ParserLayer4PortOpCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_flex_ctl(uint8 lchip, ParserLayer4FlexCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_flex_ctl(uint8 lchip, ParserLayer4FlexCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_app_ctl(uint8 lchip, ParserLayer4AppCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_app_ctl(uint8 lchip, ParserLayer4AppCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_app_data_ctl(uint8 lchip, uint8 lchip, parser_layer4_app_data_ctl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_layer4_app_data_ctl(uint8 lchip, uint8 lchip, parser_layer4_app_data_ctl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_ach_ctl(uint8 lchip, ParserLayer4AchCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_outer_hash_ctl(uint8 lchip, IpeUserIdHashCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_outer_hash_ctl(uint8 lchip, IpeUserIdHashCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_set_parser_inner_hash_ctl(uint8 lchip, IpeAclGenHashKeyCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
*/
int32
sys_goldengate_parser_io_get_parser_inner_hash_ctl(uint8 lchip, IpeAclGenHashKeyCtl_m* p_ctl)
{
    uint32 cmd = 0;
...
/**
@brief The function is to set ParserLayer2UdfCam whole entry
*/
int32
sys_goldengate_parser_io_set_parser_layer2_udf_cam(uint8 lchip, ParserLayer2UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOW(ParserLayer2UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to get ParserLayer2UdfCam whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer2_udf_cam(uint8 lchip, ParserLayer2UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOR(ParserLayer2UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to set ParserLayer2UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_set_parser_layer2_udf_cam_result(uint8 lchip, ParserLayer2UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOW(ParserLayer2UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));

    return CTC_E_NONE;
}

/**
@brief The function is to get ParserLayer2UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer2_udf_cam_result(uint8 lchip, ParserLayer2UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOR(ParserLayer2UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));
...
/**
@brief The function is to set ParserLayer3UdfCam whole entry
*/
int32
sys_goldengate_parser_io_set_parser_layer3_udf_cam(uint8 lchip, ParserLayer3UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOW(ParserLayer3UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to get ParserLayer3UdfCam whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer3_udf_cam(uint8 lchip, ParserLayer3UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOR(ParserLayer3UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to set ParserLayer3UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_set_parser_layer3_udf_cam_result(uint8 lchip, ParserLayer3UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOW(ParserLayer3UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));
...
/**
@brief The function is to get ParserLayer3UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer3_udf_cam_result(uint8 lchip, ParserLayer3UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOR(ParserLayer3UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));
...
*/
int32
sys_goldengate_parser_io_set_parser_layer4_udf_cam(uint8 lchip, ParserLayer4UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOW(ParserLayer4UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to get ParserLayer4UdfCam whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer4_udf_cam(uint8 lchip, ParserLayer4UdfCam_m* p_cam)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_cam);
    cmd = DRV_IOR(ParserLayer4UdfCam_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_cam));
...
/**
@brief The function is to set ParserLayer4UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_set_parser_layer4_udf_cam_result(uint8 lchip, ParserLayer4UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOW(ParserLayer4UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));
...
/**
@brief The function is to get ParserLayer4UdfCamResult whole entry
*/
int32
sys_goldengate_parser_io_get_parser_layer4_udf_cam_result(uint8 lchip, ParserLayer4UdfCamResult_m* p_result)
{
    uint32 cmd = 0;

    CTC_PTR_VALID_CHECK(p_result);
    cmd = DRV_IOR(ParserLayer4UdfCamResult_t, DRV_ENTRY_FLAG);
    CTC_ERROR_RETURN(DRV_IOCTL(lchip, 0, cmd, p_result));
