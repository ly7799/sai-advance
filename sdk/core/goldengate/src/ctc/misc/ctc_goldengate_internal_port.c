/**
 @file ctc_goldengate_internal_port.c
...
ctc_goldengate_set_internal_port(uint8 lchip, ctc_internal_port_assign_para_t* port_assign)
{
    ...
    CTC_ERROR_RETURN(sys_goldengate_internal_port_set(lchip, port_assign));
...
ctc_goldengate_internal_port_init(uint8 lchip, void* p_global_cfg)
{
    ...
    {
        CTC_ERROR_RETURN(sys_goldengate_internal_port_init(lchip));
    }
...
ctc_goldengate_internal_port_deinit(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_goldengate_internal_port_deinit(lchip));
    }
