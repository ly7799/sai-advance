...
*/
int32
ctc_goldengate_nexthop_init(uint8 lchip, ctc_nh_global_cfg_t* p_nh_cfg)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    ...
    if (p_nh_cfg == NULL)
    {
        ...
        nh_cfg.max_ecmp = SYS_GG_MAX_DEFAULT_ECMP_NUM;
    }
    else
    {
    ...
    {
        CTC_ERROR_RETURN(sys_goldengate_nh_api_init(lchip, &nh_cfg));
    }
...
int32
ctc_goldengate_nexthop_deinit(uint8 lchip)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_goldengate_nh_api_deinit(lchip));
    }
...
*/
int32
ctc_goldengate_nh_add_l2uc(uint8 lchip, uint32 gport,  ctc_nh_param_brguc_sub_type_t nh_type)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,
                                 ret,
                                 sys_goldengate_brguc_nh_create(lchip, gport, nh_type));
    }
...
*/
int32
ctc_goldengate_nh_remove_l2uc(uint8 lchip, uint32 gport)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_get_l2uc(uint8 lchip, uint32 gport, ctc_nh_param_brguc_sub_type_t nh_type, uint32* nhid)
{

    FEATURE_SUPPORT_CHECK(CTC_FEATURE_NEXTHOP);
    LCHIP_CHECK(lchip);

    CTC_ERROR_RETURN(sys_goldengate_l2_get_ucast_nh(lchip, gport, nh_type, nhid));
...
*/
extern int32
ctc_goldengate_nh_add_nexthop_mac(uint8 lchip, uint16 arp_id, ctc_nh_nexthop_mac_param_t* p_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_nh_add_nexthop_mac(lchip, arp_id, p_param));
    }

     /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_nh_remove_nexthop_mac(lchip, arp_id);
    }
...
*/
extern int32
ctc_goldengate_nh_remove_nexthop_mac(uint8 lchip, uint16 arp_id)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
extern int32
ctc_goldengate_nh_update_nexthop_mac(uint8 lchip, uint16 arp_id, ctc_nh_nexthop_mac_param_t* p_new_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_nh_update_nexthop_mac(lchip, arp_id, p_new_param));
    }
...
*/
int32
ctc_goldengate_nh_add_ipuc(uint8 lchip, uint32 nhid, ctc_ip_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_ipuc_nh_create(lchip, nhid, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_ipuc_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_ipuc(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_ipuc(uint8 lchip, uint32 nhid, ctc_ip_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        ...
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_ipuc_nh_update(lchip, nhid, p_nh_param, update_type));
...
*/
int32
ctc_goldengate_nh_add_ip_tunnel(uint8 lchip, uint32 nhid, ctc_ip_tunnel_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_ip_tunnel_nh_create(lchip, nhid, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_ip_tunnel_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_ip_tunnel(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_ip_tunnel(uint8 lchip, uint32 nhid, ctc_ip_tunnel_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_ip_tunnel_nh_update(lchip, nhid, p_nh_param));
    }
...
*/
int32
ctc_goldengate_nh_add_mpls_tunnel_label(uint8 lchip, uint16 tunnel_id, ctc_mpls_nexthop_tunnel_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_mpls_nh_create_tunnel_label(lchip, tunnel_id, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_mpls_nh_remove_tunnel_label(lchip, tunnel_id);
    }
...
*/
int32
ctc_goldengate_nh_remove_mpls_tunnel_label(uint8 lchip, uint16 tunnel_id)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_mpls_tunnel_label(uint8 lchip, uint16 tunnel_id, ctc_mpls_nexthop_tunnel_param_t* p_new_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_mpls_nh_update_tunnel_label(lchip, tunnel_id, p_new_param));
    }
...
*/
int32
ctc_goldengate_nh_swap_mpls_tunnel_label(uint8 lchip, uint16 old_tunnel_id,uint16 new_tunnel_id)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_mpls_nh_swap_tunnel(lchip, old_tunnel_id,new_tunnel_id));
    }
...
*/
int32
ctc_goldengate_nh_add_mpls(uint8 lchip, uint32 nhid, ctc_mpls_nexthop_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        ...
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_mpls_nh_create(lchip, nhid, &nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_mpls_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_mpls(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_mpls(uint8 lchip, uint32 nhid, ctc_mpls_nexthop_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_mpls_nh_update(lchip, nhid, p_nh_param, update_type));
    }
...
*/
int32
ctc_goldengate_nh_add_iloop(uint8 lchip, uint32 nhid, ctc_loopback_nexthop_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_iloop_nh_create(lchip, nhid, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_iloop_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_iloop(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_add_rspan(uint8 lchip, uint32 nhid, ctc_rspan_nexthop_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_rspan_nh_create(lchip, &nhid, p_nh_param->dsnh_offset, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_rspan_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_rspan(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_add_ecmp(uint8 lchip, uint32 nhid, ctc_nh_ecmp_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_ecmp_nh_create(lchip, nhid, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_ecmp_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_ecmp(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_ecmp(uint8 lchip, uint32 nhid, ctc_nh_ecmp_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_ecmp_nh_update(lchip, nhid, p_nh_param));
    }
...
*/
int32
ctc_goldengate_nh_set_max_ecmp(uint8 lchip, uint16 max_ecmp)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_goldengate_nh_set_max_ecmp(lchip, max_ecmp));
    }
...
*/
int32
ctc_goldengate_nh_get_max_ecmp(uint8 lchip, uint16* max_ecmp)
{
...
*/
int32
ctc_goldengate_nh_add_xlate(uint8 lchip, uint32 nhid, ctc_vlan_edit_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        if (p_nh_param->aps_en)
        {
            ...
            CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                     ret,
                                     sys_goldengate_aps_egress_vlan_edit_nh_create(lchip, nhid, dsnh_offset, gport_or_aps_bridge_id,
        ...
        else
        {
            ...
            CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                     ret,
                                     sys_goldengate_egress_vlan_edit_nh_create(lchip, nhid, gport_or_aps_bridge_id,
    ...
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_egress_vlan_edit_nh_delete(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_xlate(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_get_mcast_nh(uint8 lchip, uint32 group_id, uint32* p_nhid)
{

    FEATURE_SUPPORT_CHECK(CTC_FEATURE_NEXTHOP);
    LCHIP_CHECK(lchip);
    CTC_ERROR_RETURN(sys_goldengate_nh_get_mcast_nh(lchip, group_id, p_nhid));
 ...
 */
int32
ctc_goldengate_nh_add_mcast(uint8 lchip, uint32 nhid, ctc_mcast_nh_param_group_t* p_nh_mcast_group)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_mcast_nh_create(lchip, p_nh_mcast_group->mc_grp_id, &nh_mcast_group));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_goldengate_mcast_nh_delete(lchip, nhid);
    }
 ...
 */
int32
ctc_goldengate_nh_remove_mcast(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
 ...
 */
int32
ctc_goldengate_nh_update_mcast(uint8 lchip, uint32 nhid, ctc_mcast_nh_param_group_t* p_nh_mcast_group)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    uint8 all_lchip                = 0;
    ...
    switch (p_nh_mcast_group->mem_info.member_type)
    {
            ...
            if (!p_nh_mcast_group->mem_info.port_bmp_en)
            {
                ...
                else
                {
                   SYS_MAP_GPORT_TO_LCHIP(p_nh_mcast_group->mem_info.destid, lchip)
                    if (!sys_goldengate_chip_is_local(lchip, SYS_MAP_CTC_GPORT_TO_GCHIP(p_nh_mcast_group->mem_info.destid)))
                    {
        ...
        case CTC_NH_PARAM_MEM_LOCAL_WITH_NH:
            {
                ...
                nh_mcast_group.mem_info.is_src_port_check_dis = p_nh_mcast_group->mem_info.is_source_check_dis;
                CTC_ERROR_RETURN(sys_goldengate_nh_get_nhinfo_by_nhid(lchip, p_nh_mcast_group->mem_info.ref_nhid, (sys_nh_info_com_t**)&p_nh_com_info));

                if (p_nh_com_info->hdr.nh_entry_type == SYS_NH_TYPE_MCAST)
                {
                    return CTC_E_NH_INVALID_NH_TYPE;
                }
                else if (p_nh_com_info->hdr.nh_entry_type == SYS_NH_TYPE_RSPAN)
                {
                ...
                {
                    CTC_ERROR_RETURN(sys_goldengate_nh_get_port(lchip, p_nh_mcast_group->mem_info.ref_nhid, &aps_brg_en, &dest_id));
                ...
                else
                {
                    ...
                    if (!sys_goldengate_chip_is_local(lchip, SYS_MAP_CTC_GPORT_TO_GCHIP(dest_id)))
                    {
                        return CTC_E_INVALID_CHIP_ID;
                    }
                }
        ...
        case CTC_NH_PARAM_MEM_REMOTE:
           ...
           nh_mcast_group.mem_info.destid = p_nh_mcast_group->mem_info.destid & 0xFFFF;/*profile id*/
    ...
    else
    {
        CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
        {
            CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                     ret,
                                     sys_goldengate_mcast_nh_update(lchip, &nh_mcast_group));
        }
    }
    ...
    error:
        ctc_goldengate_nh_update_mcast(lchip, nhid, p_nh_mcast_group);
        return ret;
}
...
int32
ctc_goldengate_nh_add_misc(uint8 lchip, uint32 nhid, ctc_misc_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
   ...
   /*mapping REPLACE_L2HDR or REPLACE_L2_L3HDR to FLEX_EDIT_HDR */
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_nh_add_misc(lchip, &nhid, p_nh_param, FALSE));
    }
...
*/
int32
ctc_goldengate_nh_remove_misc(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_misc(uint8 lchip, uint32 nhid, ctc_misc_nh_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NOT_EXIST,
                                 ret,
                                 sys_goldengate_nh_update_misc(lchip, nhid, p_nh_param, update_type));
...
*/
int32
ctc_goldengate_nh_get_resolved_dsnh_offset(uint8 lchip, ctc_nh_reserved_dsnh_offset_type_t type, uint32* p_offset)
{
    sys_goldengate_nh_res_offset_type_t nh_type;
    ...
    CTC_ERROR_RETURN(sys_goldengate_nh_get_resolved_offset(lchip, nh_type, p_offset));
...
*/
extern int32
ctc_goldengate_nh_get_nh_info(uint8 lchip, uint32 nhid, ctc_nh_info_t* p_nh_info)
{
    ...
    CTC_ERROR_RETURN(sys_goldengate_nh_get_nhinfo(lchip, nhid, &nhinfo));
    ...
    if (nhinfo.is_mcast)
    {
        ...
        CTC_ERROR_RETURN(sys_goldengate_nh_get_mcast_member(lchip, nhid, p_nh_info));
    }
    else
    {
...
/**
 @brief Set global config max_ecmp

 @param[in] global config refer ctc_nh_global_cfg_t

 @return CTC_E_XXX

*/
int32
ctc_goldengate_nh_set_global_config(uint8 lchip, ctc_nh_global_cfg_t* p_glb_cfg)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        ...
        {
            CTC_ERROR_RETURN(sys_goldengate_nh_set_max_ecmp(lchip, p_glb_cfg->max_ecmp));
        }
    }
...
*/
int32
ctc_goldengate_nh_add_trill(uint8 lchip, uint32 nhid, ctc_nh_trill_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_EXIST,
                                 ret,
                                 sys_goldengate_nh_trill_create(lchip, nhid, p_nh_param));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start, lchip_end)
    {
        sys_goldengate_nh_trill_remove(lchip, nhid);
    }
...
*/
int32
ctc_goldengate_nh_remove_trill(uint8 lchip, uint32 nhid)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
...
*/
int32
ctc_goldengate_nh_update_trill(uint8 lchip, uint32 nhid, ctc_nh_trill_param_t* p_nh_param)
{
    uint8 lchip_start              = 0;
    uint8 lchip_end                = 0;
    int32 ret                      = CTC_E_NONE;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NH_NOT_EXIST,
                                 ret,
                                 sys_goldengate_nh_trill_update(lchip, nhid, p_nh_param));
    }
