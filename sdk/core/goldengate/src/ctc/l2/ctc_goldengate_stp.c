...
*/
int32
ctc_goldengate_stp_clear_all_inst_state(uint8 lchip, uint32 gport)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
...
*/
int32
ctc_goldengate_stp_set_vlan_stpid(uint8 lchip, uint16 vlan_id, uint8 stpid)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    {
        CTC_ERROR_RETURN(sys_goldengate_stp_set_vlan_stpid(lchip, vlan_id, stpid));
    }
...
*/
int32
ctc_goldengate_stp_get_vlan_stpid(uint8 lchip, uint16 vlan_id, uint8* stpid)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 0)
    {
        CTC_ERROR_RETURN(sys_goldengate_stp_get_vlan_stpid(lchip, vlan_id, stpid));
    }
...
*/
int32
ctc_goldengate_stp_set_state(uint8 lchip, uint32 gport, uint8 stpid, uint8 state)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 0)
    {
        CTC_ERROR_RETURN(sys_goldengate_stp_set_state(lchip, gport,   stpid,  state));
    }
...
*/
int32
ctc_goldengate_stp_get_state(uint8 lchip, uint32 gport, uint8 stpid, uint8* state)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 0)
    {
        CTC_ERROR_RETURN(sys_goldengate_stp_get_state(lchip, gport, stpid, state));
    }
...
*/
int32
ctc_goldengate_stp_init(uint8 lchip, void* stp_global_cfg)
{
    return CTC_E_NONE;
}

int32
ctc_goldengate_stp_deinit(uint8 lchip)
{
    return CTC_E_NONE;
}
