...
#ifndef _SYS_GOLDENGATE_PARSER_H
#define _SYS_GOLDENGATE_PARSER_H
#ifdef __cplusplus
extern "C" {
#endif
...
#define SYS_PAS_UDF_MAX_OFFSET          64

/**
 @brief  calculate and generate hash key method type
*/
enum sys_goldengate_parser_gen_hash_type_e
{
    SYS_GOLDENGATE_PARSER_GEN_HASH_TYPE_CRC,
    SYS_GOLDENGATE_PARSER_GEN_HASH_TYPE_XOR,
    SYS_GOLDENGATE_PARSER_GEN_HASH_TYPE_NUM
};
typedef enum sys_goldengate_parser_gen_hash_type_e ctc_goldengate_parser_gen_hash_type_t;
...
*/
extern int32
sys_goldengate_parser_get_tpid(uint8 lchip, ctc_parser_l2_tpid_t type, uint16* tpid);
...
*/
extern int32
sys_goldengate_parser_get_max_length_filed(uint8 lchip, uint16* max_length);
...
*/
extern int32
sys_goldengate_parser_get_vlan_parser_num(uint8 lchip, uint8* vlan_num);

/**
 @brief set pbb header info
*/
extern int32
sys_goldengate_parser_set_pbb_header(uint8 lchip, ctc_parser_pbb_header_t* pbb_header);

/**
 @brief get pbb header info
*/
extern int32
sys_goldengate_parser_get_pbb_header(uint8 lchip, ctc_parser_pbb_header_t* pbb_header);

/**
 @brief mapping l3type
*/
extern int32
sys_goldengate_parser_mapping_l3_type(uint8 lchip, uint8 index, ctc_parser_l2_protocol_entry_t* entry);
...
*/
extern int32
sys_goldengate_parser_set_trill_header(uint8 lchip, ctc_parser_trill_header_t* trill_header);

/**
 @brief get parser trill header info
*/
extern int32
sys_goldengate_parser_get_trill_header(uint8 lchip, ctc_parser_trill_header_t* trill_header);

/**
 @brief add l3type,can add a new l3type,addition offset for the type,can get the layer4 type
*/
extern int32
sys_goldengate_parser_mapping_l4_type(uint8 lchip, uint8 index, ctc_parser_l3_protocol_entry_t* entry);
...
*/
int32
sys_goldengate_parser_set_layer4_flag_op_ctl(uint8 lchip, uint8 index, sys_parser_l4flag_op_ctl_t* l4flag_op_ctl);

/**
 @brief set layer4 port option selection
*/
int32
sys_goldengate_parser_set_layer4_port_op_sel(uint8 lchip, sys_parser_l4_port_op_sel_t* l4port_op_sel);

/**
 @brief set layer4 port option ctl
*/
int32
sys_goldengate_parser_set_layer4_port_op_ctl(uint8 lchip, uint8 index, sys_parser_l4_port_op_ctl_t* l4port_op_ctl);

/**
 @brief set layer4 flex header
*/
extern int32
sys_goldengate_parser_set_l4flex_header(uint8 lchip, ctc_parser_l4flex_header_t* l4flex_header);

/**
 @brief get layer4 flex header
*/
extern int32
sys_goldengate_parser_get_l4flex_header(uint8 lchip, ctc_parser_l4flex_header_t* l4flex_header);

/**
 @brief set layer4 app ctl
*/
extern int32
sys_goldengate_parser_set_l4app_ctl(uint8 lchip, ctc_parser_l4app_ctl_t* l4app_ctl);

/**
 @brief get layer4 app ctl
*/
extern int32
sys_goldengate_parser_get_l4app_ctl(uint8 lchip, ctc_parser_l4app_ctl_t* l4app_ctl);
...
*/
extern int32
sys_goldengate_parser_set_global_cfg(uint8 lchip, ctc_parser_global_cfg_t* global_cfg);

/**
 @brief get parser global config info
*/
extern int32
sys_goldengate_parser_get_global_cfg(uint8 lchip, ctc_parser_global_cfg_t* global_cfg);

/**
 @brief init parser module
*/
extern int32
sys_goldengate_parser_init(uint8 lchip, void* parser_global_cfg);
