...
#define SYS_ELOOP_CHANNEL_ID         52  /**< ELOOP channel id */
#define SYS_ILOOP_CHANNEL_ID         53 /**< ILOOP channel id  */
...
/*ILoop Channel*/
#define SYS_RSV_PORT_IP_TUNNEL       (SYS_RSV_PORT_BASE+4)
#define SYS_RSV_PORT_COPP            (SYS_RSV_PORT_BASE+5)
#define SYS_RSV_PORT_ILOOP_ID        (SYS_RSV_PORT_BASE+6)
...
#define SYS_GLOBAL_CHIPID_CHECK(gchip)      \
    if ((gchip == 0x1F) || (gchip > SYS_GG_MAX_GCHIP_CHIP_ID))          \
    {                                       \
...
#define MAX_SYS_L2PDU_BASED_MACDA_ENTRY 8
...
#define MAX_SYS_L3PDU_BASED_IPDA 4
#define SYS_MAX_L2PDU_PER_PORT_ACTION_INDEX  31
#define SYS_MAX_L3PDU_ACTION_INDEX           31

#define SYS_ENQUEUE_STATS_SIZE    2048
#define SYS_DEQUEUE_STATS_SIZE    2048
#define SYS_POLICER_STATS_SIZE    4096
#define SYS_IPE_IF_STATS_SIZE     8192
#define SYS_IPE_FWD_STATS_SIZE    8192
#define SYS_ACL0_STATS_SIZE       4096
#define SYS_ACL1_STATS_SIZE       512
#define SYS_ACL2_STATS_SIZE       256
#define SYS_ACL3_STATS_SIZE       256
#define SYS_EGS_ACL0_STATS_SIZE   1024
...
extern int32
sys_goldengate_common_get_compress_near_division_value(uint8 lchip, uint32 value, uint8 division_wide,uint8 shift_bit_wide,
