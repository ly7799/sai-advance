...
*/
#ifndef _SYS_GOLDENGATE_STK_H
#define _SYS_GOLDENGATE_STK_H
#ifdef __cplusplus
extern "C" {
#endif
/***************************************************************
...
extern int32
sys_goldengate_stacking_keeplive_add_member(uint8 lchip, ctc_stacking_keeplive_t* p_keeplive_grp);

extern int32
sys_goldengate_stacking_keeplive_remove_member(uint8 lchip, ctc_stacking_keeplive_t* p_keeplive_grp);
