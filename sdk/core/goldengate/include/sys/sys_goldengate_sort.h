...
*/
#ifndef _SYS_GOLDENGATE_SORT_H
#define _SYS_GOLDENGATE_SORT_H
#ifdef __cplusplus
extern "C" {
#endif
/***************************************************************
...
struct sys_sort_key_info_s
{
    ...
    int32 (* sort_key_syn_key)(uint8 lchip, uint32 new_offset, uint32 old_offset);
};
...
extern int32
sys_goldengate_sort_key_free_offset(uint8 lchip, sys_sort_key_info_t* key_info, uint32 p_offset);

extern int32
sys_goldengate_sort_key_init_offset_array(uint8 lchip, void**** pp_offset_array, uint32 max_offset_num);
