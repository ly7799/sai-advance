/**
 @file sys_goldengate_security.h
...
#define SYS_SECURITY_PORT_UNIT_INDEX_MAX  80
#define SYS_SECURITY_VLAN_UNIT_INDEX_MAX  20

#define SYS_STMCTL_INVALID_OFFSET               CTC_MAX_UINT16_VALUE

#define SYS_SECURITY_LEARN_LIMIT_MAX            0x3FFFF

#define SYS_SECURITY_LEARN_LIMIT_THRESHOLD_MAX  0xFF
...
extern int32
sys_goldengate_mac_security_set_learn_limit(uint8 lchip, ctc_security_learn_limit_t* p_learn_limit);
...
/*storm control cfg*/
extern int32
sys_goldengate_storm_ctl_set_cfg(uint8 lchip, ctc_security_stmctl_cfg_t* stmctl_cfg);

extern int32
sys_goldengate_storm_ctl_get_cfg(uint8 lchip, ctc_security_stmctl_cfg_t* stmctl_cfg);
