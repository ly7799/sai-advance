...
#ifndef _SYS_GOLDENGATE_PDU_H
#define _SYS_GOLDENGATE_PDU_H
#ifdef __cplusplus
extern "C" {
#endif
...
#define MAX_SYS_L3PDU_ACTION_INDEX           31

/**
 @brief  Classify layer2 pdu based on macda,macda-low24 bit, layer2 header protocol
*/
extern int32
sys_goldengate_l2pdu_classify_l2pdu(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index,
...
sys_goldengate_l2pdu_get_global_action(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index,
                                      ctc_pdu_global_l2pdu_action_t* action);
extern int32
sys_goldengate_l2pdu_get_classified_key(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index,
                                       ctc_pdu_l2pdu_key_t* key);
extern int32
...
extern int32
sys_goldengate_l3pdu_get_classified_key(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index,
                                       ctc_pdu_l3pdu_key_t* key);
extern int32
sys_goldengate_l3pdu_get_global_action(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index,
...
*/
extern int32
sys_goldengate_l2pdu_set_port_action(uint8 lchip, uint16 gport, uint8 action_index,
                                    ctc_pdu_port_l2pdu_action_t action);
extern int32
sys_goldengate_l2pdu_get_port_action(uint8 lchip, uint16 gport, uint8 action_index,
                                    ctc_pdu_port_l2pdu_action_t* action);
/**
...
*/
extern int32
sys_goldengate_l3pdu_set_global_action(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index,
                                      ctc_pdu_global_l3pdu_action_t* action);
