/**
 @file sys_goldengate_vlan_mapping.h
...
#ifndef _SYS_GOLDENGATE_VLAN_MAPPING_H
#define _SYS_GOLDENGATE_VLAN_MAPPING_H
#ifdef __cplusplus
extern "C" {
#endif
...
extern int32
sys_goldengate_vlan_add_default_vlan_mapping(uint8 lchip, uint16 gport, ctc_vlan_miss_t* p_action);
extern int32
...
extern int32
sys_goldengate_vlan_add_default_egress_vlan_mapping(uint8 lchip, uint16 gport, ctc_vlan_miss_t* p_action);
extern int32
...
extern int32
sys_goldengate_vlan_add_flex_vlan_mapping_entry(uint8 lchip, uint8 label_id, ctc_vlan_mapping_t* p_vlan_mapping);

extern int32
sys_goldengate_vlan_remove_flex_vlan_mapping_entry(uint8 lchip, uint8 label_id, ctc_vlan_mapping_t* p_vlan_mapping);

extern int32
sys_goldengate_vlan_add_flex_vlan_mapping_default_entry(uint8 lchip, uint8 label_id, ctc_vlan_miss_t* p_action);

extern int32
sys_goldengate_vlan_remove_flex_vlan_mapping_default_entry(uint8 lchip, uint8 label_id);
