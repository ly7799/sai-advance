...
/*If the burst is greater than this number, the shift figured out
    by _sys_goldengate_queue_shape_threshold_compute will be error 16 */
...
extern int32
_sys_goldengate_get_port_queue_type_by_lport(uint8 lchip, uint8 lport, ctc_queue_type_t* queue_type);

extern int32
_sys_goldengate_get_per_port_queue_num_by_lport(uint8 lchip, uint8 lport, uint8* queue_num_per_port);

extern int32
_sys_goldengate_channel_shape_profile_write(uint8 lchip, uint8 channel, sys_channel_shape_profile_t* p_profile);

/**
 @brief Globally enable/disable queue shaping function.
*/
extern int32
sys_goldengate_queue_set_queue_shape_global_enable(uint8 lchip, bool enable);

/**
 @brief Get queue shape global enable status.
*/
extern int32
sys_goldengate_queue_get_queue_shape_global_enable(uint8 lchip, bool* p_enable);

/**
 @brief Globally enable/disable group shaping function.
*/
extern int32
sys_goldengate_queue_set_group_shape_global_enable(uint8 lchip, bool enable);

/**
 @brief Get group shape global enable status.
*/
extern int32
sys_goldengate_queue_get_group_shape_global_enable(uint8 lchip, bool* p_enable);

extern int32
sys_goldengate_queue_set_shape_ipg_enable(uint8 lchip, bool enable);

/**
 @brief Globally enable/disable channel shaping function.
*/
extern int32
sys_goldengate_queue_set_channel_shape_global_enable(uint8 lchip, bool enable);

/**
 @brief Get channel shape global enable stauts.
*/
extern int32
sys_goldengate_queue_get_channel_shape_global_enable(uint8 lchip, bool* p_enable);
...
*/
extern int32
sys_goldengate_queue_set_queue_shape(uint8 lchip, uint16 queue_id, ctc_queue_shape_t* p_shape);

/**
 @brief Unset shaping for the given queue in a chip.
*/
extern int32
sys_goldengate_queue_unset_queue_shape(uint8 lchip, uint16 queue_id);

/**
 @brief Get shaping for the given queue in a chip.
*/
extern int32
sys_goldengate_queue_get_queue_shape(uint8 lchip, uint16 queue_id, ctc_queue_shape_t* p_shape);

/**
 @brief Set shaping for the given channel in a chip. Channel shaping supports single-rate single-bucket algorithm.
*/
extern int32
sys_goldengate_queue_set_channel_shape(uint8 lchip, uint8 channel, ctc_port_shape_t* p_shape);

/**
 @brief Unset shaping for the given channel in a chip.
*/
extern int32
sys_goldengate_queue_unset_channel_shape(uint8 lchip, uint8 channel);

/**
 @brief Get shaping for the given channel in a chip.
*/
extern int32
sys_goldengate_queue_get_channel_shape(uint8 lchip, uint8 channel, ctc_port_shape_t* p_shape);

/**
 @brief Set queue shaping for the given service ID.
*/
extern int32
sys_goldengate_service_set_queue_shape(uint8 lchip, ctc_queue_type_t type, uint16 logical_service_id, uint8 offset, ctc_queue_shape_t* p_shape);

/**
 @brief Unset queue shaping for the given service ID.
*/
extern int32
sys_goldengate_service_unset_queue_shape(uint8 lchip, ctc_queue_type_t type, uint16 logical_service_id, uint8 offset);

/**
 @brief Get queue shaping for the given service ID.
*/
extern int32
sys_goldengate_service_get_queue_shape(uint8 lchip, ctc_queue_type_t type, uint16 logical_service_id, uint8 offset, ctc_queue_shape_t* p_shape);

/**
 @brief Set group shaping.
*/
extern int32
sys_goldengate_group_set_shape(uint8 lchip, ctc_group_shape_cfg_t* group_shape);

/**
 @brief Unset group shaping.
*/
extern int32
sys_goldengate_group_unset_shape(uint8 lchip, ctc_group_shape_cfg_t* group_shape);

/**
 @brief Get group shaping.
*/
extern int32
sys_goldengate_group_get_shape(uint8 lchip, ctc_group_shape_cfg_t* group_shape);

/**
 @brief Queue shaper initialization.
*/
extern int32
sys_goldengate_qos_init_queue_shape(uint8 lchip);
