...
\p
The centec goldengate support a variety of Ethernet network port interfaces: copper, fiber from 100M to 100Gb.
...
*/
extern int32
ctc_goldengate_port_init(uint8 lchip, void* p_port_global_cfg);
...
*/
extern int32
ctc_goldengate_port_get_mac_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_port_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_vlan_ctl(uint8 lchip, uint32 gport, ctc_vlantag_ctl_t* p_mode);
...
*/
extern int32
ctc_goldengate_port_get_default_vlan(uint8 lchip, uint32 gport, uint16* p_vid);
...
*/
extern int32
ctc_goldengate_port_get_vlan_filter_en(uint8 lchip, uint32 gport, ctc_direction_t dir, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_vlan_domain(uint8 lchip, uint32 gport, ctc_port_vlan_domain_type_t* p_vlan_domain);
...
*/
extern int32
ctc_goldengate_port_get_dot1q_type(uint8 lchip, uint32 gport, ctc_dot1q_type_t* p_type);
...
*/
extern int32
ctc_goldengate_port_get_transmit_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_receive_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_bridge_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_phy_if_en(uint8 lchip, uint32 gport, uint16* p_l3if_id, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_stag_tpid_index(uint8 lchip, uint32 gport, ctc_direction_t dir, uint8* p_index);
...
*/
extern int32
ctc_goldengate_port_get_learning_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_use_outer_ttl(uint8 lchip, uint32 gport, bool* p_enable);
...
/**
 ...
 @remark untag transmit packet's svlan/cvlan id if packet's svlan/cvlan id equal to default vlan id of the port
...
/**
 ...
 @remark  get untag default vlan id enable/disable on svlan or cvlan.

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_port_get_untag_dft_vid(uint8 lchip, uint32 gport, bool* p_enable, bool* p_untag_svlan);
...
*/
extern int32
ctc_goldengate_port_get_protocol_vlan_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_random_log_en(uint8 lchip, uint32 gport, ctc_direction_t dir, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_random_log_percent(uint8 lchip, uint32 gport, ctc_direction_t dir, uint8* p_percent);
...
*/
extern int32
ctc_goldengate_port_set_vlan_range(uint8 lchip, uint32 gport, ctc_vlan_range_info_t* p_vrange_info, bool enable);
...
*/
extern int32
ctc_goldengate_port_get_vlan_range(uint8 lchip, uint32 gport, ctc_vlan_range_info_t* p_vrange_info, bool* p_enable);
...
/**
 ...
 @param[in] speed_mode  Speed at 10M 100M 1G of Gmac, 10G(XFI) 40G 100G of Sgmac

 @remark  When enable mac, set the speed for mac, refer to ctc_port_speed_t
...
*/
extern int32
ctc_goldengate_port_get_speed(uint8 lchip, uint32 gport, ctc_port_speed_t* p_speed_mode);
...
*/
extern int32
ctc_goldengate_port_get_preamble(uint8 lchip, uint32 gport, uint8* p_pre_bytes);
...
*/
extern int32
ctc_goldengate_port_get_min_frame_size(uint8 lchip, uint32 gport, uint8* p_size);
...
/**
 ...
 @remark   If a packet length less than 63 bytes then the packet length will be paded to be 64 bytes when enable the function
...
*/
extern int32
ctc_goldengate_port_get_pading_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_srcdiscard_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_port_get_port_check_en(uint8 lchip, uint32 gport, bool* p_enable);
...
*/
extern int32
ctc_goldengate_get_ipg_size(uint8 lchip, ctc_ipg_size_t index, uint8* p_size);
...
*/
extern int32
ctc_goldengate_port_get_ipg(uint8 lchip, uint32 gport, ctc_ipg_size_t* p_index);
...
/**
 ...
 @param[in] p_port_isolation    restriction group param
...
*/
extern int32
ctc_goldengate_port_set_isolation(uint8 lchip_id, ctc_port_isolation_t* p_port_isolation);
...
*/
extern int32
ctc_goldengate_port_get_isolation(uint8 lchip_id, ctc_port_isolation_t* p_port_isolation);
...
*/
extern int32
ctc_goldengate_port_get_property(uint8 lchip, uint32 gport, ctc_port_property_t port_prop, uint32* p_value);
...
*/
extern int32
ctc_goldengate_port_get_direction_property(uint8 lchip, uint32 gport, ctc_port_direction_property_t port_prop, ctc_direction_t dir, uint32* p_value);
...
*/
extern int32
ctc_goldengate_port_get_mac_link_up(uint8 lchip, uint32 gport, bool* p_is_up);
...
*/
extern int32
ctc_goldengate_port_set_port_mac_postfix(uint8 lchip, uint32 gport, ctc_port_mac_postfix_t* p_port_mac);
...
*/
extern int32
ctc_goldengate_port_get_port_mac(uint8 lchip, uint32 gport, mac_addr_t* p_port_mac);
...
*/
extern int32
ctc_goldengate_port_get_reflective_bridge_en(uint8 lchip, uint32 gport, bool* p_enable);
...
/**
 ...
 @remark Set system global min frame size for per port selection, index range is 0 to 7.
 @return CTC_E_XXX
*/
extern int32
...
/**
 ...
 @remark Get system global min frame size for per port selection, index range is 0 to 7.
 @return CTC_E_XXX
*/
extern int32
...
/**
 ...
 @remark Set system global max frame size for per port selection, index range is 0 to 7.
 @return CTC_E_XXX
*/
extern int32
...
/**
 ...
 @remark Get system global max frame size for per port selection, index range is 0 to 7.
 @return CTC_E_XXX
*/
extern int32
