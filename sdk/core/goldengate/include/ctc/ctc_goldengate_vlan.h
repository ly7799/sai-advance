...
Goldengate support convenient way to create vlan by ctc_vlan_create_uservlan() which will automatically create vlan default entry.
...
#ifndef _CTC_GOLDENGATE_VLAN_H
#define _CTC_GOLDENGATE_VLAN_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_vlan_add_ports(uint8 lchip_id, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
/**
 ...
 @remark
        Add the gport to the VLAN. At the same time allow vlan on the specify ports.
...
/**
 @brief  Remove member port to a vlan
...
*/
extern int32
ctc_goldengate_vlan_remove_ports(uint8 lchip_id, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
*/
extern int32
ctc_goldengate_vlan_set_tagged_ports(uint8 lchip_id, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
/**
