/**
 @file ctc_goldengate_sync_ether.h
...
#ifndef _CTC_GOLDENGATE_SYNC_ETHER_H
#define _CTC_GOLDENGATE_SYNC_ETHER_H
#ifdef __cplusplus
extern "C" {
#endif
/***************************************************************
...
/**
 ...
 @remark  Initialize SyncE module and set default config.
 \p
          Default config:
 \p
...
*/
extern int32
ctc_goldengate_sync_ether_init(uint8 lchip, void* sync_ether_global_cfg);
...
/**
 ...
 @remark  User can de-initialize the sync_ether configuration

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_sync_ether_deinit(uint8 lchip);
...
/**
 ...
 @remark  Set SyncE module works as you expect.
 \p
...
*/
extern int32
ctc_goldengate_sync_ether_set_cfg(uint8 lchip_id, uint8 sync_ether_clock_id, ctc_sync_ether_cfg_t* p_sync_ether_cfg);
...
/**
 ...
 @remark  Get the config information of the SyncE module.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_sync_ether_get_cfg(uint8 lchip_id, uint8 sync_ether_clock_id, ctc_sync_ether_cfg_t* p_sync_ether_cfg);
