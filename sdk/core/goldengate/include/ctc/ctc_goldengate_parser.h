/**
 ...
 \S ctc_parser.h:ctc_parser_pkt_type_t
 \S ctc_parser.h:ctc_parser_l2_type_t
 \S ctc_parser.h:ctc_parser_l3_type_t
 \S ctc_parser.h:ctc_parser_l2_tpid_t
 \S ctc_parser.h:ctc_parser_l2_hash_flags_t
 \S ctc_parser.h:ctc_parser_ip_ecmp_hash_flags_t
 \S ctc_parser.h:ctc_parser_ip_hash_flags_t
 \S ctc_parser.h:ctc_parser_mpls_ecmp_hash_flag_t
 \S ctc_parser.h:ctc_parser_mpls_hash_flag_t
 \S ctc_parser.h:ctc_parser_ecmp_hash_type_t
 \S ctc_parser.h:ctc_parser_hash_type_t
 \S ctc_parser.h:ctc_parser_tunnel_type_t
 \S ctc_parser.h:ctc_parser_tunnel_hash_mode_t
 \S ctc_parser.h:ctc_parser_udf_type_t
 \S ctc_parser.h:ctc_parser_l2_protocol_entry_t
 \S ctc_parser.h:ctc_parser_l3_protocol_entry_t
 \S ctc_parser.h:ctc_parser_l4flex_header_t
 \S ctc_parser.h:ctc_parser_hash_ctl_t
 \S ctc_parser.h:ctc_parser_udf_t

*/

#ifndef CTC_GOLDENGATE_PARSER_H_
#define CTC_GOLDENGATE_PARSER_H_
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 @brief Set L3/L4 UDF key and offset

 @param[in] lchip    local chip id

 @param[in] index   If value is 0xFFFFFFFF, store the udf key automatically and satified most longest match,
                    else store udf specified by index directly.

 @param[in] udf   UDF key and offset info

 @remark    Set L3/L4 UDF key and offset

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_parser_set_udf(uint8 lchip, uint32 index, ctc_parser_udf_t* udf);

/**
 @brief Get L3/L4 UDF key and offset

 @param[in] lchip    local chip id

 @param[in]  index   If value is 0xFFFFFFFF, get the udf info by key stored in p_udf,
                     else get udf info by index specified directly.

 @param[out] udf     UDF key and offset
...
*/
extern int32
ctc_goldengate_parser_get_udf(uint8 lchip, uint32 index, ctc_parser_udf_t* udf);
