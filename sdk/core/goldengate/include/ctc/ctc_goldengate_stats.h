...
#ifndef _CTC_GOLDENGATE_STATS_H
#define _CTC_GOLDENGATE_STATS_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @param[in] gport  global port of the system, portid value is ignored, since cpu port is fixed.
...
*/
extern int32
ctc_goldengate_stats_intr_callback_func(uint8 lchip, uint8* gchip);
