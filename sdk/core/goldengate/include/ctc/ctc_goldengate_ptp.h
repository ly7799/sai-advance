...
\p
 (2)The ToD Interface is used to synchronize the time information between other devices and local clock. ToD information
...
#ifndef _CTC_GOLDENGATE_PTP_H
#define _CTC_GOLDENGATE_PTP_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_ptp_get_clock_timestamp(uint8 lchip_id, ctc_ptp_time_t* p_timestamp);
...
*/
extern int32
ctc_goldengate_ptp_adjust_clock_offset(uint8 lchip_id, ctc_ptp_time_t* p_offset);
...
*/
extern int32
ctc_goldengate_ptp_set_clock_drift(uint8 lchip_id, ctc_ptp_time_t* p_drift);
...
*/
extern int32
ctc_goldengate_ptp_get_clock_drift(uint8 lchip_id, ctc_ptp_time_t* p_drift);
...
*/
extern int32
ctc_goldengate_ptp_set_sync_intf(uint8 lchip_id, ctc_ptp_sync_intf_cfg_t* p_sync_cfg);
...
*/
extern int32
ctc_goldengate_ptp_get_sync_intf(uint8 lchip_id, ctc_ptp_sync_intf_cfg_t* p_sync_cfg);
...
*/
extern int32
ctc_goldengate_ptp_set_sync_intf_toggle_time(uint8 lchip_id, ctc_ptp_time_t* p_toggle_time);
...
*/
extern int32
ctc_goldengate_ptp_get_sync_intf_toggle_time(uint8 lchip_id, ctc_ptp_time_t* p_toggle_time);
...
*/
extern int32
ctc_goldengate_ptp_get_sync_intf_code(uint8 lchip_id, ctc_ptp_sync_intf_code_t* p_time_code);
...
*/
extern int32
ctc_goldengate_ptp_set_tod_intf(uint8 lchip_id, ctc_ptp_tod_intf_cfg_t* p_tod_cfg);
...
*/
extern int32
ctc_goldengate_ptp_get_tod_intf(uint8 lchip_id, ctc_ptp_tod_intf_cfg_t* p_tod_cfg);
...
*/
extern int32
ctc_goldengate_ptp_set_tod_intf_tx_code(uint8 lchip_id, ctc_ptp_tod_intf_code_t* p_tx_code);
...
*/
extern int32
ctc_goldengate_ptp_get_tod_intf_tx_code(uint8 lchip_id, ctc_ptp_tod_intf_code_t* p_tx_code);
...
*/
extern int32
ctc_goldengate_ptp_get_tod_intf_rx_code(uint8 lchip_id, ctc_ptp_tod_intf_code_t* p_rx_code);
...
*/
extern int32
ctc_goldengate_ptp_get_captured_ts(uint8 lchip_id, ctc_ptp_capured_ts_t* p_captured_ts);
