/**
 @file ctc_goldengate_internal_port.h
 ...
 The CTC internal port module is a resource module, it provides mechanism to facilitate
 complex applications which not be supported in normal packet procedure. Depend on applications,
 such as ipswap and macswap, mcast mirror or L2VPN interconvert L3VPN, the application may need iloop,
 eloop or both to satisfy requirement.
 ...
 necessary to separate internal port loop mechanism from special applications. Beside to specify
...
#ifndef _CTC_GOLDENGATE_INTERNAL_PORT_H_
#define _CTC_GOLDENGATE_INTERNAL_PORT_H_
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_set_internal_port(uint8 lchip, ctc_internal_port_assign_para_t* port_assign);
...
*/
extern int32
ctc_goldengate_alloc_internal_port(uint8 lchip, ctc_internal_port_assign_para_t* port_assign);
...
*/
extern int32
ctc_goldengate_free_internal_port(uint8 lchip, ctc_internal_port_assign_para_t* port_assign);
...
*/
extern int32
ctc_goldengate_internal_port_init(uint8 lchip, void* p_global_cfg);
...
*/
extern int32
ctc_goldengate_internal_port_deinit(uint8 lchip);
