...
#ifndef _CTC_GOLDENGATE_NH_H
#define _CTC_GOLDENGATE_NH_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_nexthop_init(uint8 lchip, ctc_nh_global_cfg_t* nh_cfg);
...
/**
 ...
 @remark Set Nexthop global config,include max ecmp, mpls tunnel number etc
...
/**
 ...
 @remark This API is called to add a trill nexthop, the nexthop contains the outgoing port, nickname etc
...
/**
 ...
 @remark  Delete TRILL nexthop with the given nhid,
          and you need to delete all the forwarding tables use this Nexthop before deleting it.
