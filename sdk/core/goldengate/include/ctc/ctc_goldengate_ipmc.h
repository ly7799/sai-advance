...
#ifndef _CTC_GOLDENGATE_IPMC_H
#define _CTC_GOLDENGATE_IPMC_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark  Initialize the IPMC module, including global variable such as max vrfid number, ipmc lookup mode, default entry, etc.
...
*/
extern int32
ctc_goldengate_ipmc_init(uint8 lchip, void* ipmc_global_cfg);
...
/**
 ...
 @remark  User can de-initialize the ipmc configuration

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_ipmc_deinit(uint8 lchip);
...
/**
 ...
 @remark  Add an ip multicaset group with not member and member information not used in parameter p_group.
                \p
...
*/
extern int32
ctc_goldengate_ipmc_add_group(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Remove an existed ip multicast group address (S,G) or (*,G) with the specified VRFID.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_ipmc_remove_group(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Add member ports into an existed multicast group, multiple IPMC member can share the same IPMC group ID.
...
*/
extern int32
ctc_goldengate_ipmc_add_member(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Remove member ports from an existed multicast group.
                Use CTC_IPMC_FLAG_L2MC if member is L2MC based on IP.
...
*/
extern int32
ctc_goldengate_ipmc_remove_member(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Update the RPF check interface of an existed multicast group by setting parameter rpf_intf and rpf_intf_valid.
...
*/
extern int32
ctc_goldengate_ipmc_update_rpf(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Add the rp interfaces not block of an existed rp id by setting parameter rp_intf_count and rp_intf.
...
*/
extern int32
ctc_goldengate_ipmc_add_rp_intf(uint8 lchip, ctc_ipmc_rp_t* p_rp);
...
/**
 ...
 @remark  Add the rp interfaces block of an existed rp id by setting parameter rp_intf_count and rp_intf.
                Support 16 source interfaces check at once.
...
*/
extern int32
ctc_goldengate_ipmc_remove_rp_intf(uint8 lchip, ctc_ipmc_rp_t* p_rp);
/**
 ...
 @remark  Get group info by address, src_ip_mask_len, group_ip_mask_len, ip_version. You can get group id info of ipmc group.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_ipmc_get_group_info(uint8 lchip, ctc_ipmc_group_info_t* p_group);
...
/**
 ...
 @remark  Add the default action for both ipv4 and ipv6 ipmc. Default action type:
                \p
...
*/
extern int32
ctc_goldengate_ipmc_add_default_entry(uint8 lchip, uint8 ip_version, ctc_ipmc_default_action_t type);
...
/**
 ...
 @remark  Set force mcast ucast or bridge for both ipv4 and ipv6 in a certern ipda range.
...
*/
extern int32
ctc_goldengate_ipmc_set_mcast_force_route(uint8 lchip, ctc_ipmc_force_route_t* p_data);
...
/**
 ...
 @remark  Get force mcast ucast or bridge to parameter ip_addr0, addr0_mask, force_bridge_en, force_ucast_en.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_ipmc_get_mcast_force_route(uint8 lchip, ctc_ipmc_force_route_t* p_data);
