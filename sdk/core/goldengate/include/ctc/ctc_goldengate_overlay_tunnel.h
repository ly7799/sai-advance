/**
 @file ctc_goldengate_overlay_tunnel.h
...
\d Perorms layer 2 switching between NvGRE/VxLAN and non-NvGRE/VxLAN device
...
\pp
support multiple aceess type, port/port+vlan/port+mac+vlan/vlan through API:
\pp
...
#ifndef _CTC_GOLDENGATE_OVERLAY_TUNNEL_H
#define _CTC_GOLDENGATE_OVERLAY_TUNNEL_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_overlay_tunnel_init(uint8 lchip, void* param);
...
/**
 ...
 @remark  User can de-initialize the overlay_tunnel configuration
...
/**
 ...
 @remark  maping vn_id to fid which used to forwarding lookup
...
/**
 ...
 @remark  get maping vn_id to fid which used to forwarding lookup
...
/**
 @brief get the vn_id , fid relation of an overlay network instance, only used for fid to vn_id that is N:1 mode
 ...
 @remark  get maping fid to vn_id which used to forwarding lookup
...
/**
 ...
 @remark terminating the NvGRE/VxLAN tunnel, default is E-LAN,
...
/**
 ...
 @remark remove the specific overlay tunnel
...
/**
 ...
 @remark update the specific overlay tunnel
...
#endif /*end of _CTC_GOLDENGATE_OVERLAY_TUNNEL_H*/
