...
\p
 ...
 The Forwarding Instance ID (FID) is wide concept in the CTC SDK. As the L2 forwarding look up is based on MAC+FID  in the Goldengate,
 ...
 are supported in the Goldengate. Several mappings to FID can be done and are described as followed.
\p
...
\p
 ...
 In Goldengate, L2MC, IPMC, VLAN based broadcast and VSI based broadcast are using multicast replication, and
...
#ifndef _CTC_GOLDENGATE_L2_H
#define _CTC_GOLDENGATE_L2_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark Initialize the Goldengate fdb subsystem, including global variable, soft table, asic table, etc.
...
/**
 ...
 @remark   Create a layer2 multicast group with MAC/FID and multicast group id,and the search key
...
/**
 ...
 @remark   Create a default entry  with FID and multicast group id  by multicast method ,and the search key
...
#endif /*end of _CTC_GOLDENGATE_L2_H*/
