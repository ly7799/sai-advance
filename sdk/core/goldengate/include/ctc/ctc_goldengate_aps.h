/**
 ...
 \b
 GoldenGate implements quick switching in forwarding data path while the APS protocol needs to run in a separate
 CPU if necessary. Once a failure is detected on the data path by OAM or other mechanisms,
 the CPU will be notified and it will trigger GoldenGate to perform the quick switching.
 GoldenGate implements a protocol/topology independent APS mechanism to perform quick protection switching.
 ...
 GoldenGate APS can support up to 2 level protections switching, with each level works independently.
...
#ifndef _CTC_GOLDENGATE_APS_H
#define _CTC_GOLDENGATE_APS_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark Initialize the Goldengate aps subsystem, including global variable, soft table, asic table, etc.
...
/**
 ...
 @remark  User can de-initialize the aps configuration
...
/**
 ...
 @remark Create APS bridge group by APS group id and configure information.
...
/**
 ...
 @remark Set APS bridge group by APS group id and configure information.
                set w_l3if_id/p_l3if_id when use vlan interface.
                set physical_isolated for layer 2 APS protection when don't edit packet info.
...
/**
 ...
 @remark Create APS bridge group by APS group id.
...
/**
 ...
 @remark Set working path of APS bridge group.
...
/**
 ...
 @remark Get working path of APS bridge group.
...
/**
 ...
 @remark Set protection path of APS bridge group.
...
/**
 ...
 @remark Get protection path of APS bridge group.
...
/**
 ...
 @remark Set APS bridge to working path or protection path.
...
/**
 ...
 @remark Set APS selector from working path or protection path.
...
/**
 ...
 @remark Get APS selector status.
...
/**
 ...
 @remark create R-APS mcast group.
...
/**
 ...
 @remark remove R-APS mcast group.
...
/**
 ...
 @remark update R-APS group member.
