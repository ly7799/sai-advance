/**
 ...
 \S ctc_chip.h:ctc_chip_access_type_t
 \S ctc_chip.h:ctc_chip_gpio_mode_t
 \S ctc_chip.h:ctc_chip_serdes_mode_t
 \S ctc_chip.h:ctc_chip_mdio_type_t
 \S ctc_chip.h:ctc_chip_serdes_polynome_type_t
 \S ctc_chip.h:ctc_chip_property_t
 \S ctc_chip.h:ctc_chip_serdes_ffe_mode_t
 \S ctc_chip.h:ctc_chip_serdes_ffe_t
 \S ctc_chip.h:ctc_chip_mem_scan_cfg_t
 \S ctc_chip.h:ctc_chip_i2c_read_t
 \S ctc_chip.h:ctc_chip_i2c_write_t
 \S ctc_chip.h:ctc_chip_serdes_info_t
 \S ctc_chip.h:ctc_chip_serdes_prbs_t
 \S ctc_chip.h:ctc_chip_serdes_polarity_t
 \S ctc_chip.h:ctc_chip_serdes_peaking_t
 \S ctc_chip.h:ctc_datapath_serdes_prop_t
*/

#ifndef _CTC_GOLDENGATE_CHIP_H
#define _CTC_GOLDENGATE_CHIP_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_set_gchip_id(uint8 lchip_id, uint8 gchip_id);
...
*/
extern int32
ctc_goldengate_get_gchip_id(uint8 lchip_id, uint8* gchip_id);
...
/**
 ...
 @remark   To enable/disable phy auto scan.The interface just set on chip0.If want to set on other chip, please
...
*/
extern int32
ctc_goldengate_chip_i2c_write(uint8 lchip, ctc_chip_i2c_write_t* i2c_para);
...
/**
 ...
 @remark   To set mac led enable.The interface just set gpio on chip0.If want to set gpio on other chip, please
                using interface :ctc_chip_set_property
...
*/
extern int32
ctc_goldengate_chip_set_gpio_output(uint8 lchip, uint8 gpio_id, uint8 out_para);
...
/**
 ...
 @param[in]  in_value this para is only used in input mode, it indicate the input is high or low
                The interface just set gpio on chip0.If want to set gpio on other chip, please
                using interface :ctc_chip_set_property

 @remark   To get gpio input value

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_chip_get_gpio_input(uint8 lchip, uint8 gpio_id, uint8* in_value);
...
*/
extern int32
ctc_goldengate_chip_set_serdes_mode(uint8 lchip_id, ctc_chip_serdes_info_t* p_serdes_info);
...
/**
 ...
 @remark   this interface is used for access phy using mdio parameter, if you want to access phy by GPORT parameter,
                please using the interface:ctc_goldengate_chip_read_xgphy_reg/ctc_goldengate_chip_read_gephy_reg

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_chip_mdio_read(uint8 lchip_id, ctc_chip_mdio_type_t type, ctc_chip_mdio_para_t* p_para);
...
/**
 ...
 @remark   this interface is used for access phy using mdio parameter, if you want to access phy by GPORT parameter,
                please using the interface:ctc_goldengate_chip_write_gephy_reg/ctc_goldengate_chip_write_xgphy_reg

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_chip_mdio_write(uint8 lchip_id, ctc_chip_mdio_type_t type, ctc_chip_mdio_para_t* p_para);
...
/**
 ...
 @remark   To Set port/mdio and port/phy mapping on local chip0. If want to set other chip
...
*/
extern int32
ctc_goldengate_chip_set_property(uint8 lchip_id,  ctc_chip_property_t chip_prop,  void* p_value);
...
/**
 ...
 @remark get chip property

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_chip_get_property(uint8 lchip_id,  ctc_chip_property_t chip_prop,  void* p_value);
...
*/
extern int32
ctc_goldengate_get_chip_sensor(uint8 lchip_id, ctc_chip_sensor_type_t type, uint32* p_value);
