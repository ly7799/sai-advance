/**
 ...
 Goldengate support the new feature EFD(Elephant Flow Detect). The EFD function is useful to detect
...
\p
 ...
 elephant flow will be aginged. The aging info will be sended to CPU by DMA. You can use
 ctc_efd_register_cb() to register a callback function to get the aging info.

 \S ctc_efd.h:ctc_efd_global_control_type_t
 \S ctc_efd.h:ctc_efd_data_t

*/

#ifndef _CTC_GOLDENGATE_EFD_H
#define _CTC_GOLDENGATE_EFD_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark This function set the global control register of EFD.
...
/**
 ...
 @remark This function get the global control register of EFD.
...
/**
 ...
 @remark This function register the callback function for flow aging.
...
/**
 ...
 @remark This function initialize tables and registers structures for EFD module.
...
/**
 ...
 @remark  User can de-initialize the efd configuration

 @return CTC_E_XXX
*/
extern int32
ctc_goldengate_efd_deinit(uint8 lchip);
