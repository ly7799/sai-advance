/**
 ...
 Goldengate supports 2 types of L3 interfaces: logic IP VLAN interfaces and physical IP interfaces. Total IP interface
 number is up to 1022. For each L3 interface, the corresponding data structures at IPE is souce interface property table
 ...
 Because Goldengate supports 4K VLAN, nexthop table's destVlanPtr[12] must be zero.
 \p
 \b
...
*/
#ifndef _CTC_GOLDENGATE_L3_IF
#define _CTC_GOLDENGATE_L3_IF
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark    Goldengate support 2 types of interface : Vlan L3if and Phy L3if. These two types of L3if share 1022
...
*/
extern int32
ctc_goldengate_l3if_create(uint8 lchip, uint16 l3if_id, ctc_l3if_t* p_l3_if);
...
*/
extern int32
ctc_goldengate_l3if_destory(uint8 lchip, uint16 l3if_id, ctc_l3if_t* p_l3_if);
...
extern int32
ctc_goldengate_l3if_get_property(uint8 lchip, uint16 l3if_id, ctc_l3if_property_t l3if_prop, uint32* p_value);
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark      Get the system router mac value.
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark     Set the L3 interface's router mac, this mac can be different from system router mac and other
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark      Get the interface router mac value.
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark         Create l3 interface for ecmp.
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark         Destory l3 interface for ecmp.
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark         Add l3 interface member for l3if for ecmp.
...
/**
 ...
 @param[in] lchip    local chip id
     ...
     @remark         Remove l3 interface member for l3if for ecmp.
