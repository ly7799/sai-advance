...
\b
The GoldenGate OAM Engine provides control of the following OAM features for CFM and Y.1731:
\p
...
\B BFD
\p
Bidirectional Forwarding Detection (BFD) defined in RFC5880 is a simple mechanism which detects the liveness
...
\b
The GoldenGate OAM Engine provides control of the following OAM features for BFD:
\p
...
\d Set throughtput config by ctc_oam_set_trpt_cfg()
\d Enable/disable throughtput measurement by ctc_oam_set_trpt_en()
\d Get and clear throughtput statistics by ctc_oam_get_trpt_stats()/ctc_oam_clear_trpt_stats()
...
#ifndef _CTC_GOLDENGATE_OAM_H
#define _CTC_GOLDENGATE_OAM_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @param[in]  p_lmep   local mep data structure pointer
...
/**
 ...
 @param[in]  p_rmep   remote mep data structure pointer
...
/**
 ...
 @param[in]  p_mip   mip data structure pointer
...
*/
extern int32
ctc_goldengate_oam_get_defect_info(uint8 lchip_id, void* p_defect_info);
...
*/
extern int32
ctc_goldengate_oam_get_mep_info(uint8 lchip_id, ctc_oam_mep_info_t* p_mep_info);
...
*/
extern int32
ctc_goldengate_oam_set_trpt_cfg(uint8 lchip, ctc_oam_trpt_t* p_throughput);
...
/**
 ...
 @remark  Must set throughput parameter by ctc_oam_set_trpt_para first, then enable throughput session.
