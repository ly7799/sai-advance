/**
 @file ctc_goldengate_security.h
 ...
 limited on edge point of network. Goldengate support port and vlan base storm control and total is 63 controls entry which port and vlan shares
 ...
 \b
 \p
 There are two ways to support PVlan in Goldengate.
 \pp
...
#ifndef _CTC_GOLDENGATE_SECURITY_H
#define _CTC_GOLDENGATE_SECURITY_H
#ifdef __cplusplus
extern "C" {
#endif
