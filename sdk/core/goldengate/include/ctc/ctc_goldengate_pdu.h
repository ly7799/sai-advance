...
#ifndef _CTC_GOLDENGATE_PDU_H
#define _CTC_GOLDENGATE_PDU_H
#ifdef __cplusplus
extern "C" {
#endif
...
*/
extern int32
ctc_goldengate_l2pdu_classify_l2pdu(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index, ctc_pdu_l2pdu_key_t* key);
...
*/
extern int32
ctc_goldengate_l2pdu_get_classified_key(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index, ctc_pdu_l2pdu_key_t* key);
...
*/
extern int32
ctc_goldengate_l2pdu_set_global_action(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index, ctc_pdu_global_l2pdu_action_t* action);
...
*/
extern int32
ctc_goldengate_l2pdu_get_global_action(uint8 lchip, ctc_pdu_l2pdu_type_t l2pdu_type, uint8 index, ctc_pdu_global_l2pdu_action_t* action);
...
*/
extern int32
ctc_goldengate_l2pdu_set_port_action(uint8 lchip, uint32 gport, uint8 action_index, ctc_pdu_port_l2pdu_action_t action);
...
/**
 ...
 @remark  Get layer2 pdu per port action of a certern action index on port. There are four actions:
          \p
...
*/
extern int32
ctc_goldengate_l2pdu_get_port_action(uint8 lchip, uint32 gport, uint8 action_index, ctc_pdu_port_l2pdu_action_t* action);
...
/**
 ...
 @remark  Classify layer3 pdu based on layer3 header protocol,layer4 dest port.
         ...
         \p
         Use the CTC_PDU_L3PDU_TYPE_LAYER3_IPADDR flag to classify layer3 pdu based on layer3 ip address.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_l3pdu_classify_l3pdu(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index, ctc_pdu_l3pdu_key_t* key);
/**
 ...
 @remark  Get layer3 pdu key based on layer3 header protocol,layer4 dest port.
          ...
          \p
          Use the CTC_PDU_L3PDU_TYPE_LAYER3_IPADDR flag to get layer3 pdu key based on layer3 ip address.

 @return CTC_E_XXX

*/
extern int32
ctc_goldengate_l3pdu_get_classified_key(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index, ctc_pdu_l3pdu_key_t* key);
...
*/
extern int32
ctc_goldengate_l3pdu_set_global_action(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index, ctc_pdu_global_l3pdu_action_t* action);
/**
...
*/
extern int32
ctc_goldengate_l3pdu_get_global_action(uint8 lchip, ctc_pdu_l3pdu_type_t l3pdu_type, uint8 index, ctc_pdu_global_l3pdu_action_t* action);
...
/**
 ...
 @remark Set the action of layer3 interface's exception.
         \p
         input action_index:
         \p
         max index num is 16.
