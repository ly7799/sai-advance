...
#ifndef _CTC_GREATBELT_CHIP_GLOBAL_H
#define _CTC_GREATBELT_CHIP_GLOBAL_H
#ifdef __cplusplus
extern "C" {
#endif
...
#define SYS_LCHIP_CHECK_ACTIVE(lchip)                       \
    do {                                                    \
        if(0 != sys_greatbelt_chip_check_active(lchip)){              \
...
#define SYS_LCHIP_CHECK_ACTIVE_IN_THREAD(lchip)             \
    do {                                                    \
        int32 (op) = 0;                                     \
        (op)=(sys_greatbelt_chip_check_active(lchip));                \
        if ((op)<0)                                         \
        {                                                   \
            return;                                         \
        }                                                   \
...
extern int32 sys_greatbelt_chip_set_active(uint8 lchip, uint32 value);
