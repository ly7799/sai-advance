/**
 @file ctc_greatbelt_interrupt.h
 ...
 \p
 \d sys_greatbelt_interrupt.c implements the APIs (init, set_en, get_en, clear_status, get_status) and the dispatch of groups and interrupts.
 \d sys_greatbelt_interrupt_isr.c implements the default configurations of interrupt and the declaration of interrupt callback functions.
 \b
 ...
 \d initialize interrupt module by parameter or by change group & interrupt default configuration in sys_greatbelt_interrupt_isr.c
 \b
...
#ifndef _CTC_GREATBELT_INTERRUPT_H
#define _CTC_GREATBELT_INTERRUPT_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark  User can initialize the interrupt configuration by two means:
\p
          1. change the default configuration in sys_greatbelt_interrupt_isr.c
\p
          2. though p_global_cfg parameter
\p
          If the p_global_cfg is NULL, SDK will use the first; otherwise, use the second.

 @return CTC_E_XXX
*/
extern int32
ctc_greatbelt_interrupt_init(uint8 lchip, void* p_global_cfg);
...
*/
extern int32
ctc_greatbelt_interrupt_deinit(uint8 lchip);
...
*/
extern int32
ctc_greatbelt_interrupt_clear_status(uint8 lchip_id, ctc_intr_type_t* p_type);
...
*/
extern int32
ctc_greatbelt_interrupt_get_status(uint8 lchip_id, ctc_intr_type_t* p_type, ctc_intr_status_t* p_status);
...
*/
extern int32
ctc_greatbelt_interrupt_set_en(uint8 lchip_id, ctc_intr_type_t* p_type, uint32 enable);
...
*/
extern int32
ctc_greatbelt_interrupt_get_en(uint8 lchip_id, ctc_intr_type_t* p_type, uint32* p_enable);
...
*/
extern int32
ctc_greatbelt_interrupt_register_event_cb(uint8 lchip, ctc_interrupt_event_t event, CTC_INTERRUPT_EVENT_FUNC cb);
