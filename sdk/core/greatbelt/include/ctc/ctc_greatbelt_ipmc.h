...
#ifndef _CTC_GREATBELT_IPMC_H
#define _CTC_GREATBELT_IPMC_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 ...
 @remark  Remove an existed ip multicaset group address (S,G) or (*,G) with the specified VRFID.
...
/**
 ...
 @param[in] p_data   An point reference to ctc_ipmc_v4_force_route_t.
...
/**
 ...
 @remark  Goes through IPMC table and runs the user callback function at each valid IPMC entry, passing back the
                information for that IPMC entry..
