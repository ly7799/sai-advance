...
ctc_greatbelt_oam_add_maid(uint8 lchip, ctc_oam_maid_t* p_maid)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_OAM);

    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN( CTC_E_OAM_MAID_ENTRY_EXIST,
                                  ret,
                                  sys_greatbelt_oam_add_maid(lchip, p_maid));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_oam_remove_maid(lchip, p_maid);
    }
...
ctc_greatbelt_oam_add_lmep(uint8 lchip, ctc_oam_lmep_t* p_lmep)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_LMEP_EXIST,
                                  ret,
                                  sys_greatbelt_oam_add_lmep(lchip, p_lmep));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_oam_remove_lmep(lchip, p_lmep);
    }
...
ctc_greatbelt_oam_update_lmep(uint8 lchip, ctc_oam_update_t* p_lmep)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_LMEP_NOT_FOUND,
                                  ret,
                                  sys_greatbelt_oam_update_lmep(lchip, p_lmep));
    }
...
ctc_greatbelt_oam_add_rmep(uint8 lchip, ctc_oam_rmep_t* p_rmep)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_LMEP_NOT_FOUND,
                                  ret,
                                  sys_greatbelt_oam_add_rmep(lchip, p_rmep));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_oam_remove_rmep(lchip, p_rmep);
    }
...
ctc_greatbelt_oam_update_rmep(uint8 lchip, ctc_oam_update_t* p_rmep)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_LMEP_NOT_FOUND,
                                  ret,
                                  sys_greatbelt_oam_update_rmep(lchip, p_rmep));
    }
...
ctc_greatbelt_oam_add_mip(uint8 lchip, ctc_oam_mip_t* p_mip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_ENTRY_EXIST,
                                  ret,
                                  sys_greatbelt_oam_add_mip(lchip, p_mip));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_oam_remove_mip(lchip, p_mip);
    }
...
ctc_greatbelt_oam_set_property(uint8 lchip, ctc_oam_property_t* p_prop)
{
    ...
    {
        CTC_ERROR_RETURN(sys_greatbelt_oam_set_property(lchip, p_prop));
    }
...
ctc_greatbelt_oam_get_mep_info_with_key(uint8 lchip, ctc_oam_mep_info_with_key_t* p_mep_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_OAM_CHAN_LMEP_NOT_FOUND,
                                  ret,
                                  sys_greatbelt_oam_get_mep_info(lchip, p_mep_info, 1));
    }
...
ctc_greatbelt_oam_get_stats(uint8 lchip, ctc_oam_stats_info_t* p_stat_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN( CTC_E_OAM_CHAN_ENTRY_NOT_FOUND,
                                  ret,
                                  sys_greatbelt_oam_get_stats_info(lchip, p_stat_info));
    }
...
ctc_greatbelt_oam_set_trpt_cfg(uint8 lchip, ctc_oam_trpt_t* p_trpt)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_oam_set_trpt_cfg(lchip, p_trpt));
    }
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_OAM);
    CTC_ERROR_RETURN(sys_greatbelt_oam_set_trpt_en(lchip, gchip, session_id, enable));
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_OAM);
    CTC_ERROR_RETURN(sys_greatbelt_oam_get_trpt_stats(lchip, gchip, session_id, p_trpt_stats));
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_OAM);
    CTC_ERROR_RETURN(sys_greatbelt_oam_clear_trpt_stats(lchip, gchip, session_id));
    return CTC_E_NONE;
}
...
ctc_greatbelt_oam_init(uint8 lchip, ctc_oam_global_t* p_cfg)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_oam_init(lchip, &oam_global));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_oam_deinit(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_oam_deinit(lchip));
    }
