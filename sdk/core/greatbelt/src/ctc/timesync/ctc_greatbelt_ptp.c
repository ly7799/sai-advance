...
ctc_greatbelt_ptp_init(uint8 lchip, ctc_ptp_global_config_t* p_ptp_cfg)
{
    ...
    if (NULL == p_ptp_cfg)
    {
        ...
        ptp_cfg.ptp_ucast_en = 1;
        ptp_cfg.sync_copy_to_cpu_en = 0;
        ptp_cfg.signaling_copy_to_cpu_en = 0;
        ptp_cfg.management_copy_to_cpu_en = 0;
        ptp_cfg.delay_request_process_en = 1;
        ptp_cfg.port_based_ptp_en = 1;
    ...
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_init(lchip, p_ptp_cfg));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_deinit(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_deinit(lchip));
    }
...
ctc_greatbelt_ptp_set_global_property(uint8 lchip, ctc_ptp_global_prop_t property, uint32 value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_global_property(lchip, property, value));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_get_global_property(uint8 lchip, ctc_ptp_global_prop_t property, uint32* value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_global_property(lchip, property, value));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_clock_timestamp(uint8 lchip, ctc_ptp_time_t* p_timestamp)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_clock_timestamp(lchip, p_timestamp));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_adjust_clock_offset(uint8 lchip, ctc_ptp_time_t* p_offset)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_adjust_clock_offset(lchip, p_offset));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_set_clock_drift(uint8 lchip, ctc_ptp_time_t* p_drift)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_clock_drift(lchip, p_drift));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_clock_drift(uint8 lchip, ctc_ptp_time_t* p_drift)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_clock_drift(lchip, p_drift));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_set_device_type(uint8 lchip, ctc_ptp_device_type_t device_type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_device_type(lchip, device_type));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_get_device_type(uint8 lchip, ctc_ptp_device_type_t* p_device_type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_device_type(lchip, p_device_type));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_set_adjust_delay(uint8 lchip, uint32 gport, ctc_ptp_adjust_delay_type_t type, int64 value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_adjust_delay(lchip, gport, type, value));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_get_adjust_delay(uint8 lchip, uint32 gport, ctc_ptp_adjust_delay_type_t type, int64* value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_adjust_delay(lchip, gport, type, value));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_set_sync_intf(uint8 lchip, ctc_ptp_sync_intf_cfg_t* p_sync_cfg)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_sync_intf(lchip, p_sync_cfg));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_sync_intf(uint8 lchip, ctc_ptp_sync_intf_cfg_t* p_sync_cfg)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_sync_intf(lchip, p_sync_cfg));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_set_sync_intf_toggle_time(uint8 lchip, ctc_ptp_time_t* p_toggle_time)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_sync_intf_toggle_time(lchip, p_toggle_time));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_sync_intf_toggle_time(uint8 lchip, ctc_ptp_time_t* p_toggle_time)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_sync_intf_toggle_time(lchip, p_toggle_time));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_sync_intf_code(uint8 lchip, ctc_ptp_sync_intf_code_t* p_time_code)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_sync_intf_code(lchip, p_time_code));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_clear_sync_intf_code(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_clear_sync_intf_code(lchip));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_set_tod_intf(uint8 lchip, ctc_ptp_tod_intf_cfg_t* p_tod_cfg)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_tod_intf(lchip, p_tod_cfg));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_tod_intf(uint8 lchip, ctc_ptp_tod_intf_cfg_t* p_tod_cfg)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_tod_intf(lchip, p_tod_cfg));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_set_tod_intf_tx_code(uint8 lchip, ctc_ptp_tod_intf_code_t* p_tx_code)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_set_tod_intf_tx_code(lchip, p_tx_code));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_tod_intf_tx_code(uint8 lchip, ctc_ptp_tod_intf_code_t* p_tx_code)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_tod_intf_tx_code(lchip, p_tx_code));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_tod_intf_rx_code(uint8 lchip, ctc_ptp_tod_intf_code_t* p_rx_code)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_tod_intf_rx_code(lchip, p_rx_code));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_ptp_clear_tod_intf_code(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_clear_tod_intf_code(lchip));
    }
    return CTC_E_NONE;
}
...
*/
int32
ctc_greatbelt_ptp_get_captured_ts(uint8 lchip, ctc_ptp_capured_ts_t* p_captured_ts)
{
    uint8 lchip_start = 0;
    uint8 lchip_end = 0;
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_ptp_get_captured_ts(lchip, p_captured_ts));
    }
    return CTC_E_NONE;
}
