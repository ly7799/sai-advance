...
STATIC int32
_ctc_greatbelt_scl_map_action_type(ctc_scl_action_type_t ctc_type, sys_scl_action_type_t* sys_type)
{
    switch (ctc_type)
    {
...
STATIC int32
_ctc_greatbelt_scl_map_key_type(ctc_scl_key_type_t ctc_type, sys_scl_key_type_t* sys_type)
{
    switch (ctc_type)
    {
    ...
    case CTC_SCL_KEY_TCAM_IPV4:
        *sys_type = SYS_SCL_KEY_TCAM_IPV4;
        break;
...
STATIC int32
_ctc_greatbelt_scl_map_action(ctc_scl_action_t* ctc, sys_scl_action_t* sys)
{
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_action_type(ctc->type, &(sys->type)));
...
STATIC int32
_ctc_greatbelt_scl_map_key(ctc_scl_key_t* ctc, sys_scl_key_t* sys)
{
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_key_type(ctc->type, &(sys->type)));
...
STATIC int32
_ctc_greatbelt_scl_get_lchip_by_gport(uint32 gport_type,
                                       uint32 gport,
                                       uint8* lchip_id,
                                       uint8* all_lchip)
{
...
ctc_greatbelt_scl_init(uint8 lchip, void* scl_global_cfg)
{
    ...
    uint8 lchip_end                 = 0;
    LCHIP_CHECK(lchip);
    FEATURE_SUPPORT_CHECK(lchip, CTC_FEATURE_SCL);
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_scl_init(lchip, scl_global_cfg));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_scl_deinit(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_scl_deinit(lchip));
    }
...
ctc_greatbelt_scl_create_group(uint8 lchip, uint32 group_id, ctc_scl_group_info_t* group_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_SCL_GROUP_EXIST,
                                 ret,
                                 sys_greatbelt_scl_create_group(lchip, group_id, group_info, 0));
    }
    ...
    if (all_lchip)
    {
        ...
        {
            sys_greatbelt_scl_destroy_group(lchip, group_id, 0);
        }
    }
...
ctc_greatbelt_scl_install_group(uint8 lchip, uint32 group_id, ctc_scl_group_info_t* group_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ACL_SCL_FOREACH_ERROR_RETURN(CTC_E_SCL_GROUP_UNEXIST,
                                 ret,
                                 sys_greatbelt_scl_install_group(lchip, group_id, group_info, 0));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start, lchip_end)
    {
        sys_greatbelt_scl_uninstall_group(lchip, group_id, 0);
    }
...
ctc_greatbelt_scl_uninstall_group(uint8 lchip, uint32 group_id)
{
    ...
    CTC_FOREACH_ROLLBACK(lchip_start, lchip_end)
    {
        sys_greatbelt_scl_install_group(lchip, group_id, NULL, 0);
    }
...
ctc_greatbelt_scl_get_group_info(uint8 lchip, uint32 group_id, ctc_scl_group_info_t* group_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        ret = sys_greatbelt_scl_get_group_info(lchip, group_id, group_info, 0);
        if(CTC_E_NONE == ret)
        {
            break;
        }
...
ctc_greatbelt_scl_add_entry(uint8 lchip, uint32 group_id, ctc_scl_entry_t* scl_entry)
{
    ...
    {
    case CTC_SCL_KEY_HASH_PORT:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_key.gport_type,
                                               scl_entry->key.u.hash_port_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_CVLAN:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_cvlan_key.gport_type,
                                               scl_entry->key.u.hash_port_cvlan_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_SVLAN:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_svlan_key.gport_type,
                                               scl_entry->key.u.hash_port_svlan_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_2VLAN:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_2vlan_key.gport_type,
                                               scl_entry->key.u.hash_port_2vlan_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_CVLAN_COS:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_cvlan_cos_key.gport_type,
                                               scl_entry->key.u.hash_port_cvlan_cos_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_SVLAN_COS:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_svlan_cos_key.gport_type,
                                               scl_entry->key.u.hash_port_svlan_cos_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_MAC:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_mac_key.gport_type,
                                               scl_entry->key.u.hash_port_mac_key.gport,
                                               &lchip_id,
                                               &all_lchip);
        break;
    case CTC_SCL_KEY_HASH_PORT_IPV4:
        _ctc_greatbelt_scl_get_lchip_by_gport(scl_entry->key.u.hash_port_ipv4_key.gport_type,
    ...
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_action(&scl_entry->action ,&sys.action));
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_key(&scl_entry->key ,&sys.key));
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_ACL_SCL_FOREACH_ERROR_RETURN(CTC_E_SCL_GROUP_UNEXIST,
                                 ret,
                                 sys_greatbelt_scl_add_entry(lchip, group_id, &sys, 0));
    }
    ...
    if (all_lchip)
    {
        ...
        CTC_FOREACH_ROLLBACK(lchip_start, lchip_end)
        {
            sys_greatbelt_scl_remove_entry(lchip, scl_entry->entry_id, 0);
        }
    }
...
ctc_greatbelt_scl_remove_entry(uint8 lchip, uint32 entry_id)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN2(CTC_E_SCL_GROUP_UNEXIST, CTC_E_ENTRY_NOT_EXIST,
                                  ret,
                                  sys_greatbelt_scl_remove_entry(lchip, entry_id, 0));
    }
...
ctc_greatbelt_scl_install_entry(uint8 lchip, uint32 entry_id)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN2(CTC_E_SCL_GROUP_UNEXIST, CTC_E_ENTRY_NOT_EXIST,
                                  ret,
                                  sys_greatbelt_scl_install_entry(lchip, entry_id, 0));
    }

    /*rollback if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start, lchip_end)
    {
        sys_greatbelt_scl_uninstall_entry(lchip, entry_id, 0);
    }
...
ctc_greatbelt_scl_remove_all_entry(uint8 lchip, uint32 group_id)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ACL_SCL_FOREACH_ERROR_RETURN(CTC_E_SCL_GROUP_UNEXIST,
                                 ret,
                                 sys_greatbelt_scl_remove_all_entry(lchip, group_id, 0));
    }
...
ctc_greatbelt_scl_set_entry_priority(uint8 lchip, uint32 entry_id, uint32 priority)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN2(CTC_E_SCL_GROUP_UNEXIST, CTC_E_ENTRY_NOT_EXIST,
                                  ret,
                                  sys_greatbelt_scl_set_entry_priority(lchip, entry_id, priority, 0));
    }
...
ctc_greatbelt_scl_get_multi_entry(uint8 lchip, ctc_scl_query_t* query)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        ret = sys_greatbelt_scl_get_multi_entry(lchip, query, 0);
        if(CTC_E_NONE == ret)
        {
            break;
        }
...
ctc_greatbelt_scl_update_action(uint8 lchip, uint32 entry_id, ctc_scl_action_t* action)
{
    ...
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_action_type(action->type ,&sys.type));
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ACL_SCL_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,
                                 ret,
                                 sys_greatbelt_scl_update_action(lchip, entry_id, &sys, 0));
    }
...
ctc_greatbelt_scl_set_default_action(uint8 lchip, ctc_scl_default_action_t* def_action)
{
    ...
    CTC_ERROR_RETURN(_ctc_greatbelt_scl_map_action_type(def_action->action.type ,&sys.type));
    sal_memcpy(&sys.u.igs_action,  &def_action->action.u.igs_action, sizeof(def_action->action.u.igs_action));

    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        /*in function: sys_greatbelt_scl_set_default_action
          if chip is not local, it returns CTC_E_NONE*/
        CTC_ERROR_RETURN(sys_greatbelt_scl_set_default_action(lchip, def_action->gport, &sys));
    }
...
ctc_greatbelt_scl_copy_entry(uint8 lchip, ctc_scl_copy_entry_t* copy_entry)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN2(CTC_E_ENTRY_NOT_EXIST, CTC_E_SCL_GROUP_UNEXIST,
                                 ret,
                                 sys_greatbelt_scl_copy_entry(lchip, copy_entry, 0));
    }
