...
ctc_greatbelt_vlan_init(uint8 lchip, ctc_vlan_global_cfg_t* vlan_global_cfg)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    ...
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_init(lchip, vlan_global_cfg));
        CTC_ERROR_RETURN(sys_greatbelt_vlan_class_init(lchip, vlan_global_cfg));
        CTC_ERROR_RETURN(sys_greatbelt_vlan_mapping_init(lchip));
    }
...
ctc_greatbelt_vlan_deinit(uint8 lchip)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_mapping_deinit(lchip));
        CTC_ERROR_RETURN(sys_greatbelt_vlan_class_deinit(lchip));
        CTC_ERROR_RETURN(sys_greatbelt_vlan_deinit(lchip));
    }
...
ctc_greatbelt_vlan_create_vlan(uint8 lchip, uint16 vlan_id)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_EXIST,ret,sys_greatbelt_vlan_create_vlan(lchip, vlan_id));
    }

    /*roll back if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_vlan_remove_vlan(lchip,vlan_id);
    }
    return ret;
}

/**
 @brief The function is to create a vlan with default-entry/uservlanptr
*/
int32
ctc_greatbelt_vlan_create_uservlan(uint8 lchip, ctc_vlan_uservlan_t* user_vlan)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_EXIST, ret, sys_greatbelt_vlan_create_uservlan(lchip, user_vlan));
    }
...
ctc_greatbelt_vlan_destroy_vlan(uint8 lchip, uint16 vlan_id)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_NOT_CREATE,ret,sys_greatbelt_vlan_remove_vlan(lchip, vlan_id));
    }
    return ret;
}
/**
...
*/
int32
ctc_greatbelt_vlan_add_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap)
{
    FEATURE_SUPPORT_CHECK(lchip, CTC_FEATURE_VLAN);
    LCHIP_CHECK(lchip);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_add_ports(lchip, vlan_id, port_bitmap));
...
ctc_greatbelt_vlan_add_port(uint8 lchip, uint16 vlan_id, uint32 gport)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_add_port(lchip, vlan_id, gport));
...
ctc_greatbelt_vlan_get_ports(uint8 lchip, uint16 vlan_id, uint8 gchip, ctc_port_bitmap_t port_bitmap)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_ports(lchip, vlan_id, gchip, port_bitmap));

    return CTC_E_NONE;
}
/**
 @brief The function is to remove member ports from a vlan
*/
int32
ctc_greatbelt_vlan_remove_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap)
{
    FEATURE_SUPPORT_CHECK(lchip, CTC_FEATURE_VLAN);
    LCHIP_CHECK(lchip);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_remove_ports(lchip, vlan_id, port_bitmap));
...
ctc_greatbelt_vlan_remove_port(uint8 lchip, uint16 vlan_id, uint32 gport)
{
    SYS_MAP_GPORT_TO_LCHIP(gport, lchip);
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_remove_port(lchip, vlan_id, gport));
...
ctc_greatbelt_vlan_set_tagged_port(uint8 lchip, uint16 vlan_id, uint32 gport, bool tagged)
{
    SYS_MAP_GPORT_TO_LCHIP(gport, lchip);
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_set_tagged_port(lchip, vlan_id, gport, tagged));
...
ctc_greatbelt_vlan_get_tagged_ports(uint8 lchip, uint16 vlan_id, uint8 gchip, ctc_port_bitmap_t port_bitmap)
{
    SYS_MAP_GCHIP_TO_LCHIP(gchip, lchip);
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_tagged_ports(lchip, vlan_id, gchip, port_bitmap));
...
ctc_greatbelt_vlan_set_receive_en(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_RECEIVE_EN, enable));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_receive_en(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_RECEIVE_EN, &value));
...
ctc_greatbelt_vlan_set_transmit_en(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_TRANSMIT_EN, enable));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_transmit_en(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_PTR_VALID_CHECK(enable);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_TRANSMIT_EN, &value));
    *enable = value ? TRUE : FALSE;
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_bridge_en(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_BRIDGE_EN, enable));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_bridge_en(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_PTR_VALID_CHECK(enable);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_BRIDGE_EN, &value));
    *enable = value ? TRUE : FALSE;
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_fid(uint8 lchip, uint16 vlan_id, uint16 fid)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_FID, fid));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_fid(uint8 lchip, uint16 vlan_id, uint16* fid)
{
    ...
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_FID, &value_32));
    *fid = value_32 & 0xffff;
...
ctc_greatbelt_vlan_set_learning_en(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_LEARNING_EN, enable));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_learning_en(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_PTR_VALID_CHECK(enable);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_LEARNING_EN, &value));
    *enable = value ? TRUE : FALSE;
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_igmp_snoop_en(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_IGMP_SNOOP_EN, enable));
    }
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_get_igmp_snoop_en(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_PTR_VALID_CHECK(enable);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_IGMP_SNOOP_EN, &value));
    *enable = value ? TRUE : FALSE;
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_dhcp_excp_type(uint8 lchip, uint16 vlan_id, ctc_exception_type_t type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_DHCP_EXCP_TYPE, type));
    }
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_DHCP_EXCP_TYPE, (uint32*)type));
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_arp_excp_type(uint8 lchip, uint16 vlan_id, ctc_exception_type_t type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, CTC_VLAN_PROP_ARP_EXCP_TYPE, type));
    }
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, CTC_VLAN_PROP_ARP_EXCP_TYPE, (uint32*)type));
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_property(uint8 lchip, uint16 vlan_id, ctc_vlan_property_t vlan_prop, uint32 value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_property(lchip, vlan_id, vlan_prop, value));
    }
    return CTC_E_NONE;
}
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_property(lchip, vlan_id, vlan_prop, value));
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_set_direction_property(uint8 lchip, uint16 vlan_id, ctc_vlan_direction_property_t vlan_prop, ctc_direction_t dir, uint32 value)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_direction_property(lchip, vlan_id, vlan_prop, dir, value));
    }
...
{
    FEATURE_SUPPORT_CHECK(lchip,CTC_FEATURE_VLAN);
    CTC_ERROR_RETURN(sys_greatbelt_vlan_get_direction_property(lchip, vlan_id, vlan_prop, dir, value));
    return CTC_E_NONE;
}
...
ctc_greatbelt_vlan_add_vlan_class(uint8 lchip, ctc_vlan_class_t* p_vlan_class)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_vlan_class(lchip, p_vlan_class));
    }

    /*roll back if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_vlan_remove_vlan_class(lchip,p_vlan_class);
    }
...
ctc_greatbelt_vlan_remove_vlan_class(uint8 lchip, ctc_vlan_class_t* p_vlan_class)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_vlan_class(lchip, p_vlan_class));
    }
...
ctc_greatbelt_vlan_remove_all_vlan_class(uint8 lchip, ctc_vlan_class_type_t type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_all_vlan_class(lchip, type));
    }
...
ctc_greatbelt_vlan_add_default_vlan_class(uint8 lchip, ctc_vlan_class_type_t type, ctc_vlan_miss_t* p_action)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_default_vlan_class(lchip, type, p_action));
    }

    /*roll back if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_vlan_remove_default_vlan_class(lchip,type);
    }
...
ctc_greatbelt_vlan_remove_default_vlan_class(uint8 lchip, ctc_vlan_class_type_t type)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_default_vlan_class(lchip, type));
    }
    return ret;
}
...
ctc_greatbelt_vlan_create_vlan_range_group(uint8 lchip, ctc_vlan_range_info_t* vrange_info, bool is_svlan)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_RANGE_EXIST,ret,sys_greatbelt_vlan_create_vlan_range(lchip, vrange_info, is_svlan));
    }

    /*roll back if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_vlan_destroy_vlan_range(lchip, vrange_info);
    }
    return ret;
}
...
ctc_greatbelt_vlan_destroy_vlan_range_group(uint8 lchip, ctc_vlan_range_info_t* vrange_info)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_RANGE_NOT_EXIST,ret,sys_greatbelt_vlan_destroy_vlan_range(lchip, vrange_info));
    }
    return ret;
}
...
ctc_greatbelt_vlan_add_vlan_range(uint8 lchip, ctc_vlan_range_info_t* vrange_info, ctc_vlan_range_t* vlan_range)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_NONE,ret,sys_greatbelt_vlan_add_vlan_range_member(lchip, vrange_info, vlan_range));
    }

    /*roll back if error exist*/
    CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
    {
        sys_greatbelt_vlan_remove_vlan_range_member(lchip, vrange_info, vlan_range);
    }
    return ret;
}
...
ctc_greatbelt_vlan_remove_vlan_range(uint8 lchip, ctc_vlan_range_info_t* vrange_info, ctc_vlan_range_t* vlan_range)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_VLAN_RANGE_NOT_EXIST,ret,sys_greatbelt_vlan_remove_vlan_range_member(lchip, vrange_info, vlan_range));
    }
    return ret;
}
...
ctc_greatbelt_vlan_add_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_mapping_t* p_vlan_mapping)
{
    ...
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
    ...
    if(1 == all_lchip)
    {
        CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
        {
            sys_greatbelt_vlan_remove_vlan_mapping(lchip,gport,p_vlan_mapping);
        }
    }
...
ctc_greatbelt_vlan_get_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_get_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
...
ctc_greatbelt_vlan_update_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_update_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
...
ctc_greatbelt_vlan_remove_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
...
ctc_greatbelt_vlan_add_default_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_miss_t* p_action)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_default_vlan_mapping(lchip, gport, p_action));
    }
    ...
    if(1 == all_lchip)
    {
        CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
        {
            sys_greatbelt_vlan_remove_default_vlan_mapping(lchip, gport);
        }
    }
...
ctc_greatbelt_vlan_remove_default_vlan_mapping(uint8 lchip, uint32 gport)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_default_vlan_mapping(lchip, gport));
    }
    return ret;
}
...
ctc_greatbelt_vlan_remove_all_vlan_mapping_by_port(uint8 lchip, uint32 gport)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_all_vlan_mapping_by_port(lchip, gport));
    }
    return ret;
}
...
ctc_greatbelt_vlan_add_egress_vlan_mapping(uint8 lchip, uint32 gport, ctc_egress_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_egress_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
    /*roll back if error exist*/
    if(1 == all_lchip)
    {
        CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
        {
            sys_greatbelt_vlan_remove_egress_vlan_mapping(lchip, gport, p_vlan_mapping);
        }
    }
    return ret;
}
...
ctc_greatbelt_vlan_remove_egress_vlan_mapping(uint8 lchip, uint32 gport, ctc_egress_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_egress_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
    return ret;
}
...
ctc_greatbelt_vlan_get_egress_vlan_mapping(uint8 lchip, uint32 gport, ctc_egress_vlan_mapping_t* p_vlan_mapping)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_get_egress_vlan_mapping(lchip, gport, p_vlan_mapping));
    }
...
ctc_greatbelt_vlan_add_default_egress_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_miss_t* p_action)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end,all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_EXIST,ret,sys_greatbelt_vlan_add_default_egress_vlan_mapping(lchip, gport, p_action));
    }
    /*roll back if error exist*/
    if(1 == all_lchip)
    {
        CTC_FOREACH_ROLLBACK(lchip_start,lchip_end)
        {
            sys_greatbelt_vlan_remove_default_egress_vlan_mapping(lchip, gport);
        }
    }
    return ret;
}
...
ctc_greatbelt_vlan_remove_default_egress_vlan_mapping(uint8 lchip, uint32 gport)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_default_egress_vlan_mapping(lchip, gport));
    }
    return ret;
}
...
ctc_greatbelt_vlan_remove_all_egress_vlan_mapping_by_port(uint8 lchip, uint32 gport)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, all_lchip)
    {
        CTC_FOREACH_ERROR_RETURN(CTC_E_ENTRY_NOT_EXIST,ret,sys_greatbelt_vlan_remove_all_egress_vlan_mapping_by_port(lchip, gport));
    }
    return ret;
}
...
ctc_greatbelt_vlan_set_mac_auth(uint8 lchip, uint16 vlan_id, bool enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_set_mac_auth(lchip, vlan_id, enable));
    }
...
ctc_greatbelt_vlan_get_mac_auth(uint8 lchip, uint16 vlan_id, bool* enable)
{
    ...
    CTC_FOREACH_LCHIP(lchip_start, lchip_end, 1)
    {
        CTC_ERROR_RETURN(sys_greatbelt_vlan_get_mac_auth(lchip, vlan_id, enable));
    }
