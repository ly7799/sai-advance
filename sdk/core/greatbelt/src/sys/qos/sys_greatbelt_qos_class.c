...
*/
int32
sys_greatbelt_qos_set_igs_cos_map_table(uint8 lchip, uint8 domain,
                                        uint8 cos,
                                        uint8 cfi,
                                        uint8 priority,
                                        uint8 color)
{
    ...
    field_id_priority = IpeClassificationCosMap_Priority0_f + field_index;
    field_id_color    = IpeClassificationCosMap_Color0_f + field_index;
...
*/
int32
sys_greatbelt_qos_get_igs_cos_map_table(uint8 lchip, uint8 domain,
                                        uint8 cos,
                                        uint8 cfi,
                                        uint8* priority,
                                        uint8* color)
...
*/
int32
sys_greatbelt_qos_set_igs_ip_prec_map_table(uint8 lchip, uint8 domain,
                                            uint8 ip_prec,
                                            uint8 priority,
                                            uint8 color)
{
    ...
    field_id_priority = IpeClassificationPrecedenceMap_Priority0_f + field_index;
    field_id_color    = IpeClassificationPrecedenceMap_Color0_f + field_index;
...
*/
int32
sys_greatbelt_qos_get_igs_ip_prec_map_table(uint8 lchip, uint8 domain,
                                            uint8 ip_prec,
                                            uint8* priority,
                                            uint8* color)
{
...
*/
int32
sys_greatbelt_qos_set_igs_dscp_map_table(uint8 lchip, uint8 domain,
                                         uint8 dscp,
                                         uint8 ecn,
                                         uint8 priority,
                                         uint8 color)
{
    ...
    field_id_priority = IpeClassificationDscpMap_Priority0_f + field_index;
    field_id_color    = IpeClassificationDscpMap_Color0_f + field_index;
...
*/
int32
sys_greatbelt_qos_get_igs_dscp_map_table(uint8 lchip, uint8 domain,
                                         uint8 dscp,
                                         uint8 ecn,
                                         uint8* priority,
                                         uint8* color)
...
*/
int32
sys_greatbelt_qos_set_igs_exp_map_table(uint8 lchip, uint8 domain,
                                        uint8 exp,
                                        uint8 priority,
                                        uint8 color)
{
    ...
    field_id_priority = IpeMplsExpMap_Priority0_f + field_index;
    field_id_color    = IpeMplsExpMap_Color0_f + field_index;
...
*/
int32
sys_greatbelt_qos_get_igs_exp_map_table(uint8 lchip, uint8 domain,
                                        uint8 exp,
                                        uint8* priority,
                                        uint8* color)
{
...
*/
int32
sys_greatbelt_qos_set_egs_cos_map_table(uint8 lchip, uint8 domain,
                                        uint8 priority,
                                        uint8 color,
                                        uint8 cos,
                                        uint8 cfi)
...
*/
int32
sys_greatbelt_qos_get_egs_cos_map_table(uint8 lchip, uint8 domain,
                                        uint8 priority,
                                        uint8 color,
                                        uint8* cos,
                                        uint8* cfi)
...
*/
int32
sys_greatbelt_qos_set_egs_dscp_map_table(uint8 lchip, uint8 domain,
                                         uint8 priority,
                                         uint8 color,
                                         uint8 dscp)
{
...
*/
int32
sys_greatbelt_qos_get_egs_dscp_map_table(uint8 lchip, uint8 domain,
                                         uint8 priority,
                                         uint8 color,
                                         uint8* dscp)
{
...
*/
int32
sys_greatbelt_qos_set_egs_exp_map_table(uint8 lchip, uint8 domain,
                                        uint8 priority,
                                        uint8 color,
                                        uint8 exp)
{
...
*/
int32
sys_greatbelt_qos_get_egs_exp_map_table(uint8 lchip, uint8 domain,
                                        uint8 priority,
                                        uint8 color,
                                        uint8* exp)
{
...
sys_greatbelt_qos_domain_map_set(uint8 lchip, ctc_qos_domain_map_t* p_domain_map)
{
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_COS_TO_PRI_COLOR:
        ...
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_igs_cos_map_table(lchip, domain,
                                                                 cos,
                                                                 cfi,
                                                                 priority,
                                                                 color));
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_DSCP_TO_PRI_COLOR:
        ...
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_igs_dscp_map_table(lchip, domain,
                                                                  dscp,
                                                                  ecn,
                                                                  priority,
                                                                  color));
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_IP_PREC_TO_PRI_COLOR:
        ...
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_igs_ip_prec_map_table(lchip, domain,
                                                                     ip_prec,
                                                                     priority,
                                                                     color));
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_EXP_TO_PRI_COLOR:
        ...
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_igs_exp_map_table(lchip, domain,
                                                                 exp,
                                                                 priority,
                                                                 color));
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_COS:
        cos = p_domain_map->hdr_pri.dot1p.cos;
        cfi = p_domain_map->hdr_pri.dot1p.dei;
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_egs_cos_map_table(lchip, domain,
                                                                 priority,
                                                                 color,
                                                                 cos,
                                                                 cfi));
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_DSCP:
        dscp = p_domain_map->hdr_pri.tos.dscp;
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_egs_dscp_map_table(lchip, domain,
                                                                  priority,
                                                                  color,
                                                                  dscp));
        break;
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_EXP:
        exp = p_domain_map->hdr_pri.exp;
        CTC_ERROR_RETURN(sys_greatbelt_qos_set_egs_exp_map_table(lchip, domain,
                                                                 priority,
                                                                 color,
                                                                 exp));
...
sys_greatbelt_qos_domain_map_get(uint8 lchip, ctc_qos_domain_map_t* p_domain_map)
{
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_COS_TO_PRI_COLOR:
        cos = p_domain_map->hdr_pri.dot1p.cos;
        cfi = p_domain_map->hdr_pri.dot1p.dei;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_igs_cos_map_table(lchip, domain,
                                                                 cos,
                                                                 cfi,
                                                                 &priority,
                                                                 &color));
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_DSCP_TO_PRI_COLOR:
        dscp = p_domain_map->hdr_pri.tos.dscp;
        ecn = p_domain_map->hdr_pri.tos.ecn;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_igs_dscp_map_table(lchip, domain,
                                                                  dscp,
                                                                  ecn,
                                                                  &priority,
                                                                  &color));
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_IP_PREC_TO_PRI_COLOR:
        ip_prec = p_domain_map->hdr_pri.ip_prec;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_igs_ip_prec_map_table(lchip, domain,
                                                                     ip_prec,
                                                                     &priority,
                                                                     &color));
        p_domain_map->priority = priority;
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_EXP_TO_PRI_COLOR:
        exp = p_domain_map->hdr_pri.exp;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_igs_exp_map_table(lchip, domain,
                                                                 exp,
                                                                 &priority,
                                                                 &color));
        p_domain_map->priority = priority;
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_COS:
        ...
        priority = p_domain_map->priority;
        color    = p_domain_map->color;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_egs_cos_map_table(lchip, domain,
                                                                 priority,
                                                                 color,
                                                                 &cos,
                                                                 &cfi));
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_DSCP:
        priority = p_domain_map->priority;
        color    = p_domain_map->color;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_egs_dscp_map_table(lchip, domain,
                                                                  priority,
                                                                  color,
                                                                  &dscp));
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_EXP:
        priority = p_domain_map->priority;
        color    = p_domain_map->color;
        CTC_ERROR_RETURN(sys_greatbelt_qos_get_egs_exp_map_table(lchip, domain,
                                                                 priority,
                                                                 color,
                                                                 &exp));
...
int32
sys_greatbelt_qos_domain_map_default(uint8 lchip)
{
    uint8 color    = 0;
    uint8 priority = 0;
    uint32 value    = 0;
    ...
    uint8 i        = 0;
    uint32 cmd = 0;
    cpu_mac_priority_map_t cpu_mac_priority_map;
    ds_priority_map_t ds_priority_map;

    sal_memset(&cpu_mac_priority_map, 0, sizeof(cpu_mac_priority_map_t));
    sal_memset(&ds_priority_map, 0, sizeof(ds_priority_map_t));
    ...
    for (domain = 0; domain < 8; domain++)
    {
        ...
        {
            priority = value * ((p_gb_queue_master[lchip]->priority_mode)? 2:8);
            CTC_ERROR_RETURN(sys_greatbelt_qos_set_igs_cos_map_table(lchip, domain,
                                                                     value,
                                                                     0,
                                                                     priority,
        ...
        {
            priority = value/((p_gb_queue_master[lchip]->priority_mode)? 4:1);
    ...
    for (domain = 0; domain < 8; domain++)
    {
        ...
        for (priority = 0; priority <= SYS_QOS_CLASS_PRIORITY_MAX; priority++)
        {
            for (color = CTC_QOS_COLOR_NONE; color < MAX_CTC_QOS_COLOR; color++)
            {
                ...
                value = priority / ((p_gb_queue_master[lchip]->priority_mode)? 2:8);
                CTC_ERROR_RETURN(sys_greatbelt_qos_set_egs_cos_map_table(lchip, domain,
                                                                         priority,
                                                                         color,
                                                                         value,
                ...
                value = priority * ((p_gb_queue_master[lchip]->priority_mode)? 4:1);
                CTC_ERROR_RETURN(sys_greatbelt_qos_set_egs_dscp_map_table(lchip, domain,
                                                                          priority,
                                                                          color,
                                                                          value));
    ...
    for (value = 0; value <= SYS_QOS_CLASS_PRIORITY_MAX; value++)
    {
        cpu_mac_priority_map.cos = value / ((p_gb_queue_master[lchip]->priority_mode)? 2:8);
        cmd = DRV_IOW(CpuMacPriorityMap_t, DRV_ENTRY_FLAG);
        CTC_ERROR_RETURN(DRV_IOCTL(lchip, value, cmd, &cpu_mac_priority_map));
    }

    cmd = DRV_IOW(DsPriorityMap_t, DRV_ENTRY_FLAG);
    for (value = 0; value < 8; value++)
    {
        ds_priority_map.color    = 3;
        ds_priority_map.cos      = value;
        ds_priority_map.priority = value * ((p_gb_queue_master[lchip]->priority_mode)? 2:8);
    ...
    {
        value = priority / ((p_gb_queue_master[lchip]->priority_mode)? 2:8);
        cmd = DRV_IOW(IpePriorityToStatsCos_t, (IpePriorityToStatsCos_Cos0_f + priority));
...
int32
sys_greatbelt_qos_domain_map_dump(uint8 lchip, uint8 domain, uint8 type)
{
    uint8 color    = 0;
    uint8 priority = 0;
    uint8 value    = 0;
    ...
    case CTC_QOS_DOMAIN_MAP_IGS_COS_TO_PRI_COLOR:
        {
            ...
            SYS_QOS_CLASS_DBG_DUMP("ingress cos + cfi -> priority + color mapping table\n");
            ...
            for (value = 0; value < 8; value++)
            {
                CTC_ERROR_RETURN(sys_greatbelt_qos_get_igs_cos_map_table(lchip, domain,
                                                                         ...
                                                                         &priority,
                                                                         &color));
                SYS_QOS_CLASS_DBG_DUMP("   cos(%d)  +  cfi(%d) -> priority(%d)  + color(%d)\n",
    ...
    case CTC_QOS_DOMAIN_MAP_EGS_PRI_COLOR_TO_COS:
        {
            ...
            for (priority = 0; priority < SYS_QOS_CLASS_PRIORITY_MAX; priority++)
            {
                for (color = CTC_QOS_COLOR_NONE; color < MAX_CTC_QOS_COLOR; color++)
                {
                    ...
                    SYS_QOS_CLASS_DBG_DUMP(" priority(%d)  + color(%d)  -> cos(%d) + cfi(%d)\n",
...
{
    CTC_ERROR_RETURN(sys_greatbelt_qos_domain_map_default(lchip));
    return CTC_E_NONE;
}
