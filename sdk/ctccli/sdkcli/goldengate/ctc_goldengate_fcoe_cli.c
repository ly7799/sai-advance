...
CTC_CLI(ctc_cli_gg_fcoe_dump,
        ctc_cli_gg_fcoe_dump_cmd,
...

{
    ...
    ret = sys_goldengate_fcoe_dump_entry(lchip, NULL);
...
{
    install_element(CTC_SDK_MODE, &ctc_cli_gg_fcoe_dump_cmd);
...
{
    uninstall_element(CTC_SDK_MODE, &ctc_cli_gg_fcoe_dump_cmd);
