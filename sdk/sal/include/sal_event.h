 ...
 * @return
 */
sal_err_t ctc_sal_event_create(sal_event_t** pevt, bool auto_reset);
 ...
 * @param[in] event
 */
void ctc_sal_event_destroy(sal_event_t* event);
 ...
 * @param[in] event
 */
void ctc_sal_event_set(sal_event_t* event);
 ...
 * @param[in] event
 */
void ctc_sal_event_reset(sal_event_t* event);
 ...
 */
bool ctc_sal_event_wait(sal_event_t* event, int32 timeout);
