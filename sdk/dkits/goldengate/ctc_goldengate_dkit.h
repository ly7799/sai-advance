...
#define OPERATIONTYPE_RESERVED                   2
...
#define CTC_DKIT_DRV_LINKAGGID_MASK              0x3F        /**< Linkagg ID mask */
...
#define CTC_DKIT_DRV_GPORT_TO_CTC_GPORT(gport)   (CTC_DKIT_SYS_LPORT_TO_CTC_GPORT(CTC_DKIT_DRV_GPORT_TO_GCHIP(gport)\
 ...
 /*CTC->DRV*/
#define CTC_DKIT_CTC_GPORT_TO_GCHIP(gport)         (((gport) >> CTC_DKIT_CTC_LPORT_LENGTH) & CTC_DKIT_GCHIP_MASK)
#define CTC_DKIT_CTC_GPORT_IS_LINKAGG_PORT(gport)         (CTC_DKIT_CTC_GPORT_TO_GCHIP(gport) == CTC_DKIT_LINKAGG_CHIPID)
...
#define CTC_DKIT_CTC_GPORT_TO_DRV_GPORT(gport) ((CTC_DKIT_CTC_GPORT_TO_GCHIP(gport) << CTC_DKIT_SYS_LPORT_LENGTH)\
                                              | CTC_DKIT_CTC_GPORT_TO_SYS_LPORT(gport))
...
#define CTC_DKIT_SERDES_NUM_PER_SLICE 48
#define CTC_DKIT_SERDES_HSS28G_NUM_PER_SLICE 2
#define CTC_DKIT_SERDES_HSS15G_NUM_PER_SLICE 5

#define CTC_DKIT_SERDES_IS_HSS28G(serdes_id) \
((((serdes_id) >= 40) && ((serdes_id) <= 47)) || (((serdes_id) >= 88) && ((serdes_id) <= 95)))

#define CTC_DKIT_HSS15G_MAP_SERDES_TO_HSSID(serdes_id) \
(((serdes_id) % CTC_DKIT_SERDES_NUM_PER_SLICE) / CTC_DKIT_SERDES_HSS15G_LANE_NUM + \
((serdes_id) / CTC_DKIT_SERDES_NUM_PER_SLICE)*CTC_DKIT_SERDES_HSS15G_NUM_PER_SLICE)

#define CTC_DKIT_HSS15G_MAP_SERDES_TO_LANEID(serdes_id)\
    ((serdes_id% CTC_DKIT_SERDES_NUM_PER_SLICE)%CTC_DKIT_SERDES_HSS15G_LANE_NUM)

#define CTC_DKIT_HSS28G_MAP_SERDES_TO_HSSID(serdes_id) \
((((serdes_id) % CTC_DKIT_SERDES_NUM_PER_SLICE) - 40) / CTC_DKIT_SERDES_HSS28G_LANE_NUM + \
((serdes_id) / CTC_DKIT_SERDES_NUM_PER_SLICE)*CTC_DKIT_SERDES_HSS28G_NUM_PER_SLICE)

#define CTC_DKIT_HSS28G_MAP_SERDES_TO_LANEID(serdes_id)\
    (((serdes_id% CTC_DKIT_SERDES_NUM_PER_SLICE) - 40)%CTC_DKIT_SERDES_HSS28G_LANE_NUM)

#define CTC_DKIT_MAP_SERDES_TO_LANE_ID(serdes_id) \
