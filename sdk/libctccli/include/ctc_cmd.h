...
void ctc_sort_node(void);
vector ctc_cmd_make_strvec(char*);
void ctc_cmd_free_strvec(vector);
vector ctc_cmd_describe_command(vector vline, ctc_vti_t* vti, int32* status);
char** ctc_cmd_complete_command(vector vline, ctc_vti_t* vti, int32* status);
