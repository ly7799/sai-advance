...
#if (HOST_IS_LE == 1)
#include "greatbelt/include/drv_struct_le.h"
#endif

#if (HOST_IS_LE == 0)
#include "greatbelt/include/drv_struct_be.h"
#endif
...
struct drv_io_callback_fun_s
{
    ...
    int32 (* drv_register_field_write)(uint8, tbls_id_t, uint32, uint32*);
    ...
    int32 (* drv_hash_index_lkup_by_key)(hash_io_by_key_para_t*, hash_io_rslt_t*);

    int32 (* drv_hash_lookup)(lookup_info_t*, lookup_result_t*);

    int32 (* drv_set_field)(tbls_id_t, fld_id_t, uint32*, uint32);
    int32 (* drv_get_field)(tbls_id_t, fld_id_t, uint32*, uint32*);
...
*/
extern drv_io_callback_fun_t drv_gb_io_api;
...
/**
  @driver get memory register information interface
*/
extern int32
drv_greatbelt_get_memory_info(uint32 mem_id, tables_info_t* prt_mem_info);

/**
  @driver g get driver work  platform  type
*/
extern int32
drv_greatbelt_get_platform_type(drv_work_platform_type_t* platform_type);
