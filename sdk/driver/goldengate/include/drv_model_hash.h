...
extern uint32 gg_hash_debug_on ;
...
extern uint32
drv_goldengate_hash_lookup_check_hash_type(hash_module_t, uint32);

/*
extern int32
drv_goldengate_hash_lookup_get_key_info_index(hash_module_t , uint32 ,uint8 *);
*/
