...
#define TABLE_INFO_PTR(tbl_id)             (&drv_gg_tbls_list[tbl_id])
#define TABLE_INFO(tbl_id)                 (drv_gg_tbls_list[tbl_id])
...
/* check chip id valid */
extern drv_init_chip_info_t drv_gg_init_chip_info;
...
extern uint16 gg_dynic_table_related_edram_bitmap[];
/**********************************************************************************
...
extern uint32
drv_goldengate_get_field_value(tbls_id_t tbl_id, fld_id_t field_id,  void* entry);
...
extern int8
drv_goldengae_table_is_tcam_key(tbls_id_t tbl_id);
...
extern int8
drv_goldengate_table_is_lpm_tcam_ip_ad(tbls_id_t tbl_id);
extern int8
drv_goldengate_table_is_lpm_tcam_nat_ad(tbls_id_t tbl_id);
extern int8
...
#endif
extern
uint32 drv_goldengate_get_tcam_addr_offset(uint8 block_num, uint8 is_mask);
extern
uint32 drv_goldengate_get_tcam_ad_addr_offset(uint8 block_num);
