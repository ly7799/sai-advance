...
extern int32
drv_goldengate_fib_acc(uint8 chip_id, uint8 acc_type, drv_fib_acc_in_t* fib_acc_in, drv_fib_acc_out_t* fib_acc_out);

extern int32
drv_goldengate_fib_acc_no_lock(uint8 chip_id, uint8 acc_type, drv_fib_acc_in_t* fib_acc_in, drv_fib_acc_out_t* fib_acc_out);

extern int32
drv_goldengate_cpu_acc(uint8 chip_id, uint8 acc_type, drv_cpu_acc_in_t* in,drv_cpu_acc_out_t* out );

extern int32
drv_goldengate_ipfix_acc(uint8 chip_id, uint8 acc_type, drv_ipfix_acc_in_t* acc_in, drv_ipfix_acc_out_t* acc_out);
