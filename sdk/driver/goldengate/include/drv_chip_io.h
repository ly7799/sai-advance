...
*/
extern int32
drv_goldengate_chip_tcam_lookup(uint8 chip_id_offset, uint8* key, int32 keysize,
...
*/
int32
drv_goldengate_chip_indirect_sram_tbl_ioctl(uint8 chip_id_offset, uint32 index,
                                uint32 cmd, void* val);
...
*/
extern int32
drv_goldengate_chip_hash_key_add_entry(uint8 chip_id_offset, void* add_para);
...
*/
extern int32
drv_goldengate_chip_hash_key_del_entry_by_key(uint8 chip_id_offset, void* del_para);
...
*/
extern int32
drv_goldengate_chip_hash_key_del_entry_by_index(uint8 chip_id_offset, void* del_para);

/**
 @brief Hash lookup I/O control API on real chip
*/
extern int32
drv_goldengate_chip_hash_lookup(uint8 chip_id_offset,
                      uint32* key,
...
*/
extern int32
drv_goldengate_chip_sram_tbl_write(uint8 chip_id_offset, tbls_id_t tbl_id,
...
*/
extern int32
drv_goldengate_chip_sram_tbl_read(uint8 chip_id_offset, tbls_id_t tbl_id,
                           uint32 index, uint32* data);
...
*/
extern int32
drv_goldengate_chip_write_sram_entry(uint8 chip_id_offset, uintptr addr,
...
*/
extern int32
drv_goldengate_chip_read_sram_entry(uint8 chip_id_offset, uintptr addr,
                                uint32* data, int32 len);
...
*/
extern int32
drv_goldengate_chip_tcam_tbl_write(uint8 chip_id_offset, tbls_id_t tbl_id,
...
*/
extern int32
drv_goldengate_chip_tcam_tbl_read(uint8 chip_id_offset, tbls_id_t tbl_id,
                               uint32 index, tbl_entry_t *entry);
...
extern int32
drv_goldengate_chip_flow_tcam_get_blknum_index(uint8 chip_id, tbls_id_t tbl_id, uint32 index, uint32 *blknum, uint32 *local_idx, uint32 *is_sec_half);
...
*/
extern int32
drv_goldengate_chip_tbl_mutex_init(uint8 chip_id_offset);

/**
 @brief register mutex init
*/
extern int32
drv_goldengate_chip_reg_mutex_init(uint8 chip_id_offset);
#endif
#endif
