...
/* parameter for CHIP_AGT_MSG_IO dma rw */
typedef struct
{
    chip_agent_msg_io_hdr_t hdr;
    uint32 ret;
    ...
    uint8  is_pause;
    uint8  rsv[2];
    uint8 buf_out[CHIP_AGT_BUF_SIZE];
} chip_agent_msg_dma_rw_t;
...
int32 drv_goldengate_chip_agent_mode(void);
int32 _goldengate_chip_agent_encode_init(uint8* buf, chip_agent_msg_init_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_init(uint8* buf, chip_agent_msg_init_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_model(uint8* buf, chip_agent_msg_model_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_model(uint8* buf, chip_agent_msg_model_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_ctrl(uint8* buf, chip_agent_msg_ctrl_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_ctrl(uint8* buf, chip_agent_msg_ctrl_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_pkt(uint8* buf, chip_agent_msg_pkt_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_pkt(uint8* buf, chip_agent_msg_pkt_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_log(uint8* buf, chip_agent_msg_log_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_log(uint8* buf, chip_agent_msg_log_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_interrupt(uint8* buf, chip_agent_msg_interrupt_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_interrupt(uint8* buf, chip_agent_msg_interrupt_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_ioctl(uint8* buf, chip_agent_msg_io_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_header(uint8* buf, chip_agent_msg_io_hdr_t* hdr, uint32 len);
int32 _goldengate_chip_agent_decode_io_ioctl(uint8* buf, chip_agent_msg_io_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_hash_ioctl(uint8* buf, chip_agent_msg_hash_ioctl_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_hash_ioctl(uint8* buf, chip_agent_msg_hash_ioctl_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_hash_lookup(uint8* buf, chip_agent_msg_hash_lookup_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_hash_lookup(uint8* buf, chip_agent_msg_hash_lookup_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_tcam_remove(uint8* buf, chip_agent_msg_tcam_remove_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_tcam_remove(uint8* buf, chip_agent_msg_tcam_remove_para_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_dma(uint8* buf, chip_agent_msg_dma_para_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_dma(uint8* buf, chip_agent_msg_dma_para_t* para, uint32 len);
int32 _goldengate_chip_agent_decode_gg_header(uint8* buffer, int32 len, ms_packet_header_t* p_header);
int32 _goldengate_chip_agent_encode_io_fib_acc_ioctl(uint8* buf, chip_agent_msg_fib_acc_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_fib_acc_ioctl(uint8* buf, chip_agent_msg_fib_acc_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_dma_dump_ioctl(uint8* buf, chip_agent_msg_dma_dump_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_dma_dump_ioctl(uint8* buf, chip_agent_msg_dma_dump_t* para, uint32 len);
int32 _goldengate_chip_agent_encode_io_dma_rw_ioctl(uint8* buf, chip_agent_msg_dma_rw_t* para, uint32* req_len);
int32 _goldengate_chip_agent_decode_io_dma_rw_ioctl(uint8* buf, chip_agent_msg_dma_rw_t* para, uint32 len);
int32 chip_agent_intr_cb(uint32 irq);
int32 drv_goldengate_register_intr_dispatch_cb(DRV_EADP_INTR_DISPATCH_CB cb);
int32 drv_goldengate_register_pkt_rx_cb(DRV_EADP_PKT_RX_CB cb);

int32 _goldengate_chip_agent_fib_acc_type_copy_data(uint8 fib_acc_type, chip_agent_msg_fib_acc_t* para, drv_fib_acc_in_t* in, drv_fib_acc_out_t* out);
int32 _goldengate_chip_agent_cpu_acc_type_copy_data(uint8 cpu_acc_type, chip_agent_msg_fib_acc_t* para, drv_cpu_acc_in_t* in, drv_cpu_acc_out_t* out);
int32 _goldengate_chip_agent_ipfix_acc_type_copy_data(chip_agent_msg_fib_acc_t* para, drv_ipfix_acc_in_t* in, drv_ipfix_acc_out_t* out);
char* _goldengate_chip_agent_io_op_str(chip_io_op_t op);
char* _goldengate_chip_agent_cmd_action_str(uint32 action);
char* _goldengate_chip_agent_hash_op_str(hash_op_type_t op);
char* _goldengate_chip_agent_cmd_fib_acc_type_str(uint32 action);
char* _goldengate_chip_agent_cmd_cpu_acc_type_str(uint32 action);
char* _goldengate_chip_agent_cmd_ipfix_acc_type_str(uint32 action);
