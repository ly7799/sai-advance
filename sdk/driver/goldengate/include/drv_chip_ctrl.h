...
extern int32
drv_goldengate_chip_read(uint8 lchip, uint32 offset, uint32* value);
extern int32
drv_goldengate_chip_write(uint8 lchip, uint32 offset, uint32 p_value);
extern int32
...
extern int32
drv_goldengate_pci_read_chip(uint8 lchip, uint32 offset, uint32 len, uint32* value);
extern int32
drv_goldengate_pci_write_chip(uint8 lchip, uint32 offset, uint32 len, uint32* value);
extern int32
drv_goldengate_i2c_read_chip(uint8 lchip, uint32 offset, uint32* value);
extern int32
drv_goldengate_i2c_write_chip(uint8 lchip, uint32 offset, uint32 value);
extern int32
drv_goldengate_i2c_read_local(uint8 lchip, uint32 offset, uint32* value);
extern int32
drv_goldengate_i2c_write_local(uint8 lchip, uint32 offset, uint32 value);
extern int32
drv_goldengate_i2c_read_hss6g(uint8 lchip, uint32 offset, uint16* value);
extern int32
