...
#if (HOST_IS_LE == 1)
#include "oam_drv_goldengate_struct_le.h"
#endif

#if (HOST_IS_LE == 0)
#include "oam_drv_goldengate_struct_be.h"
#endif
...
*/
extern int32
drv_goldengate_get_memory_info(uint32 mem_id, tables_info_t *prt_mem_info);

/**
  @driver g get driver work  platform  type
*/
extern int32
drv_goldengate_get_platform_type(drv_work_platform_type_t *platform_type);
