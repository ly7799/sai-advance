...
extern int32 drv_usw_i2c_read_chip(uint8 lchip, uint32 offset, uint32 len, uint32* value);
extern int32 drv_usw_i2c_write_chip(uint8 lchip, uint32 offset, uint32 len, uint32* value);
extern int32 _drv_usw_i2c_write_chip(uint8 lchip, uint32 offset, uint32 value);
